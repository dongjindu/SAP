...
* UD1K941018 by IG.MOON 7/16/2007 {
      if not fm_itab-hkont is initial.
        perform check_skbi_fmci  using fm_itab-hkont
...
*&---------------------------------------------------------------------*
*&      Form  CHECK_SKBI_fmci
*&---------------------------------------------------------------------*
*       text
*----------------------------------------------------------------------*
*      <--P_FM_ITAB_FIPEX  text
*----------------------------------------------------------------------*
form check_skbi_fmci   using    p_hkont
                        changing p_fm_itab_fipex.
  select single
         b~fipos into *fmci-fipos
         from skb1 as a
...
*           and b~datbis gt s_datum-low
  ...
  if sy-subrc eq 0.
    p_fm_itab_fipex = *fmci-fipos.
  endif.

endform.                    " CHECK_SKBI_fmci
