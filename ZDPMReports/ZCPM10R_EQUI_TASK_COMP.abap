...
* Description : Assign Component to Task List (Equipment)
*
*
* Modification Log
...
FORM MAIN_PROCESS.
  ...
  IF P_FILE IS INITIAL.
    PERFORM FILENAME_GET.
  ENDIF.
*** Make up IT_TREC from Excel file...
...
FORM GENERATE_BDC_DATA.
  ...
  IF IT_TREC-EQUNR NE WA_PREV_EQUNR OR
    ...
    PERFORM DYNPRO USING:
           'X' 'SAPLCPDI'    '3010',
           ' ' 'RC27E-EQUNR' IT_TREC-EQUNR,    "//Func. Loc
