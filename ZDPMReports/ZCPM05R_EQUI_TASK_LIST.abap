************************************************************************
* Program Name      : ZCPM05R_EQUI_TASK_LIST
...
* Addl Documentation:
* Description       :   This program Uploading for calibration equipment
*                       task list.
*
* Modification Logs
...
DATA: BEGIN OF IT_TREC OCCURS 0,
        EQUNR(18),      "//Equipment
        PROFIDNETZ(7),  "//Profile
*        STATU(2),      "//Status
*        VERWE(3),      "//Usage
        VAGRP(3),       "// planner group
        SLWBEZ(3),      "//Inspection point
...
FORM GENERATE_BDC_DATA.
  ...
  PERFORM DYNPRO USING:
         'X' 'SAPLCPDI'          '3010',
         ' ' 'RC27E-EQUNR'       IT_TREC-EQUNR,
         ' ' 'RC271-PROFIDNETZ'  IT_TREC-PROFIDNETZ,
         ' ' 'BDC_OKCODE'        '/00',
...
*        ' ' 'PLPOD-EKORG(01)'   IT_TREC-EKORG,
         ...
         'X' 'SAPLMLSP'           '0200',
           ' ' 'BDC_OKCODE'         '=ESB',
          ' ' 'ESLL-SRVPOS(01)'  IT_TREC-SRVPOS,
          ' ' 'ESLL-MENGE(01)'   IT_TREC-MENGE,
