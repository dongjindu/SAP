...
FORM GENERATE_BDC_DATA.
  ...
  IF IT_TREC-EQUNR NE WA_PREV_EQUNR.
    WA_COUNT = WA_COUNT + 1.
...
*            ' ' 'BDC_OKCODE'  '=BACK',
    ...
    PERFORM DYNPRO USING:
           'X' 'SAPMIEQ0'    '0100',
           ' ' 'RM63E-EQUNR' IT_TREC-EQUNR,    "//Equiment Number
           ' ' 'BDC_OKCODE'  '/00',
           ...
           'X' 'SAPLCLCA'    '0602',
           ' ' 'RMCLF-KLART' '002',   "//Class Type
           ' ' 'BDC_OKCODE'  '=KL',

           'X' 'SAPLCLFM'    '0500',
           ' ' 'RMCLF-CLASS(01)' IT_TREC-CLASS,   "//Class Number
           ' ' 'BDC_OKCODE'  '/00'.
...
*            ' ' 'BDC_OKCODE'  '=BACK',
            ...
            'X' 'SAPLCLFM'    '0500',
            ' ' 'RMCLF-CLASS(02)' IT_TREC-CLASS,   "//Class Number
            ' ' 'BDC_OKCODE'  '/00'.
