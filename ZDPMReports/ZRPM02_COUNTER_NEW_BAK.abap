...
* 08.30.2014 Victor   this is backup for ZRPM02_COUNTER_NEW
*
************************************************************************
...
*    ZSPM_COMP-TXTCDUR = IT_LTXTTAB02-TDLINE.
    ...
    CALL METHOD LINK_SERVER->ADD_STRING_ITEM
                EXPORTING ITEM_NAME = 'Activity_L1'
...
*    ZSPM_COMP-TXTCDUR = IT_LTXTTAB02-TDLINE.
    ...
    CALL METHOD LINK_SERVER->ADD_STRING_ITEM
                EXPORTING ITEM_NAME = 'Activity_L2'
                          ITEM_VALUE  = L_TEXT   "ZSPM_COMP-TXTCDMA
                          NO_FLUSH    = ' '
                IMPORTING RETCODE = RETCODE.
  ENDIF.
...
*    ZSPM_COMP-TXTCDUR = IT_LTXTTAB02-TDLINE.
    ...
    CALL METHOD LINK_SERVER->ADD_STRING_ITEM
                EXPORTING ITEM_NAME = 'Activity_L3'
                          ITEM_VALUE  = L_TEXT   "ZSPM_COMP-TXTCDMA
                          NO_FLUSH    = ' '
                IMPORTING RETCODE = RETCODE.
  ENDIF.
...
*    ZSPM_COMP-TXTCDUR = IT_LTXTTAB02-TDLINE.
    ...
    CALL METHOD LINK_SERVER->ADD_STRING_ITEM
                EXPORTING ITEM_NAME = 'Activity_L4'
                          ITEM_VALUE  = L_TEXT   "ZSPM_COMP-TXTCDMA
                          NO_FLUSH    = ' '
                IMPORTING RETCODE = RETCODE.
  ENDIF.
...
*    ZSPM_COMP-TXTCDUR = IT_LTXTTAB02-TDLINE.
    ...
    CALL METHOD LINK_SERVER->ADD_STRING_ITEM
                EXPORTING ITEM_NAME = 'Activity_L5'
                          ITEM_VALUE  = L_TEXT   "ZSPM_COMP-TXTCDMA
                          NO_FLUSH    = ' '
                IMPORTING RETCODE = RETCODE.
*  ENDIF.
...
*    ZSPM_COMP-TXTCDUR = IT_LTXTTAB02-TDLINE.
    ...
    CALL METHOD LINK_SERVER->ADD_STRING_ITEM
                EXPORTING ITEM_NAME = 'Activity_L6'
                          ITEM_VALUE  = L_TEXT   "ZSPM_COMP-TXTCDMA
                          NO_FLUSH    = ' '
                IMPORTING RETCODE = RETCODE.
*  ENDIF.
...
*    ZSPM_COMP-TXTCDUR = IT_LTXTTAB02-TDLINE.
    ...
    CALL METHOD LINK_SERVER->ADD_STRING_ITEM
                EXPORTING ITEM_NAME = 'Activity_L7'
                          ITEM_VALUE  = L_TEXT   "ZSPM_COMP-TXTCDMA
                          NO_FLUSH    = ' '
                IMPORTING RETCODE = RETCODE.
*  ENDIF.
