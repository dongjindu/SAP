...
REPORT ZCPM02R_EQUI_CREATE   NO STANDARD PAGE HEADING
...
*DATA_GENERAL-CONSTTYPE		Construction type material of the object
...
**** Installation Date for Equipment
  DATA_INSTALL-FUNCLOC	= IT_TREC-TPLNR.	"Functional location label
