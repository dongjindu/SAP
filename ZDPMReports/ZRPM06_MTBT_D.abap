...
* Addl Documentation:
* Description       :   Result of monthly actual no. of breakdown
* Modification Logs
...
**** Internal Tables for # of breakdown
DATA: IT_BDNO LIKE ZTPM_BDNO  OCCURS 0 WITH HEADER LINE.
...
*  SELECT * INTO  CORRESPONDING FIELDS OF TABLE IT_BDNO
*           FROM  ZTPM_BDNO
...
*           AND   ZMONTH = P_MONTH.
  ...
  EXEC SQL PERFORMING loop_output.
    SELECT  SHOP, AJAHR, ZMONTH, ZBDNUM
           INTO :IT_BDNO-SHOP,
                :IT_BDNO-AJAHR,
                :IT_BDNO-ZMONTH,
                :IT_BDNO-ZBDNUM
