*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZTHRBHIST_V
*   generation date: 03/26/2008 at 12:41:29 by user 103569
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZTHRBHIST_V         .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZTHRBHIST_V'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZTHRBHIST_V_EXTRACT
TOTAL = ZTHRBHIST_V_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZTHRBHIST_V'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZTHRBHIST_V-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZTHRBHIST_V_EXTRACT
TOTAL = ZTHRBHIST_V_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZTHRBHIST_V-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZTHRBHIST_V'
...
TOTAL = ZTHRBHIST_V_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZTHRBHIST_V-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZTHRBHIST_V-UPD_FLAG NE SPACE.
