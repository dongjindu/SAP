*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZHR_TIMEADMIN
*   generation date: 03/16/2011 at 16:02:20 by user HIS20094
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZHR_TIMEADMIN       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZHR_TIMEADMIN'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZHR_TIMEADMIN_EXTRACT
TOTAL = ZHR_TIMEADMIN_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZHR_TIMEADMIN'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZHR_TIMEADMIN-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHR_TIMEADMIN_EXTRACT
TOTAL = ZHR_TIMEADMIN_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZHR_TIMEADMIN-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZHR_TIMEADMIN'
...
TOTAL = ZHR_TIMEADMIN_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZHR_TIMEADMIN-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZHR_TIMEADMIN-UPD_FLAG NE SPACE.
