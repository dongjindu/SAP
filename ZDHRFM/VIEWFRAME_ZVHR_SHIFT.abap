*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVHR_SHIFT
*   generation date: 02/04/2004 at 14:45:45 by user HJHWANG
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVHR_SHIFT          .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVHR_SHIFT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVHR_SHIFT_EXTRACT
TOTAL = ZVHR_SHIFT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVHR_SHIFT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVHR_SHIFT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVHR_SHIFT_EXTRACT
TOTAL = ZVHR_SHIFT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVHR_SHIFT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVHR_SHIFT'
...
TOTAL = ZVHR_SHIFT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVHR_SHIFT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVHR_SHIFT-UPD_FLAG NE SPACE.
