...
* 2005.02.24     Furong                          fallin in firm zone
************************************************************************

REPORT zemmpm18_daily_delivery_nifz .
************************************************************************
* Data
************************************************************************
...
DATA : w_flag.
data: l_firmzone like it_ekpo-etfz1.
...
START-OF-SELECTION.
  ...
  LOOP AT it_ekko.
    ...
    do 4 times.
       ...
       loop at it_ekpo.
         l_firmzone = it_ekpo-etfz1 - 1.
         if l_firmzone <= 0.
            delete it_ekpo.
         else.
            it_ekpo-etfz1 = l_firmzone.
            modify it_ekpo.
         endif.
       endloop.
...
FORM bdc_generation.
  ...
  LOOP AT it_ekpo.
    ...
    it_eket-ebeln = 'Xxxx'.  " on chang for value change
    it_eket-ebelp = '99999'.
