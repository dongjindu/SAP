function z_dicom_store_using_fb60_miro.
*"--------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
...
*"  TABLES
*"      ITEM_DATA STRUCTURE  ZDICOM_ITEMS
...
* Call standard MIRO function
    call function 'Z_DICOM_STORE_USING_MIRO'
      exporting
        conf_archiv_id      = conf_archiv_id
        conf_doc_type       = conf_doc_type
