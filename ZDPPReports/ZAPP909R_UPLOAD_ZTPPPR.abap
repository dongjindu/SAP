************************************************************************
* Program Name      : ZAPP909R_UPLOAD_ZTPPPR
* Author            : Bobby
...
* Addl Documentation:
* Description       : 'Upload the data for the table ZTPPPR
*
* Modification Logs
* Date       Developer    RequestNo    Description
************************************************************************
REPORT ZAPP909R_UPLOAD_ZTPPPR     NO STANDARD PAGE HEADING
...
*&---------------------------------------------------------------------*
FORM UPDATE_ZTPPPR        .
  DATA LT_AEHD LIKE ZTPPPR         OCCURS 0 WITH HEADER LINE.
  LOOP AT IT_AEHD.
...
*-> Upload after all deletion
    WHEN R1.
      ...
      INSERT ZTPPPR         FROM TABLE LT_AEHD ACCEPTING DUPLICATE KEYS.
      IF SY-SUBRC EQ 0.
        COMMIT WORK.
      ELSE.
        ROLLBACK WORK.
...
*-> Upload except deletion
    WHEN R2.
      MODIFY ZTPPPR         FROM TABLE LT_AEHD.
      IF SY-SUBRC EQ 0.
        COMMIT WORK.
      ELSE.
        ROLLBACK WORK.
