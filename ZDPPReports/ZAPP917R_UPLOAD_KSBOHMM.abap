************************************************************************
* Program Name      : ZAPP917R_UPLOAD_KSBOHMM
* Author            : Bobby
...
* Addl Documentation:
* Description       : 'Upload the data for the table ZTPP_KSBOHMM
*
* Modification Logs
* Date       Developer    RequestNo    Description
************************************************************************
REPORT ZAPP917R_UPLOAD_KSBOHMM    NO STANDARD PAGE HEADING
...
*&---------------------------------------------------------------------*
*&      Form  UPDATE_ZTPP_KSBOHMM
*&---------------------------------------------------------------------*
FORM UPDATE_ZTPP_KSBOHMM  .
  DATA LT_AEHD LIKE ZTPP_KSBOHMM   OCCURS 0 WITH HEADER LINE.
  LOOP AT IT_AEHD.
...
*-> Upload after all deletion
    WHEN R1.
      ...
      INSERT ZTPP_KSBOHMM   FROM TABLE LT_AEHD ACCEPTING DUPLICATE KEYS.
      IF SY-SUBRC EQ 0.
        COMMIT WORK.
      ELSE.
        ROLLBACK WORK.
...
*-> Upload except deletion
    WHEN R2.
      MODIFY ZTPP_KSBOHMM   FROM TABLE LT_AEHD.
      IF SY-SUBRC EQ 0.
        COMMIT WORK.
      ELSE.
        ROLLBACK WORK.
