************************************************************************
* Program Name      : ZAPP911R_UPLOAD_ZTBM_ABXOPVDT
* Author            : Bobby
...
* Addl Documentation:
* Description       : 'Upload the data for the table ZTBM_ABXOPVDT
*
* Modification Logs
* Date       Developer    RequestNo    Description
************************************************************************
REPORT ZAPP911R_UPLOAD_ZTBM_ABXOPVDT  NO STANDARD PAGE HEADING
...
*&---------------------------------------------------------------------*
*&      Form  UPDATE_ZTBM_ABXOPVDT
*&---------------------------------------------------------------------*
FORM UPDATE_ZTBM_ABXOPVDT .
  DATA LT_AEHD LIKE ZTBM_ABXOPVDT  OCCURS 0 WITH HEADER LINE.
  LOOP AT IT_AEHD.
...
*-> Upload after all deletion
    WHEN R1.
      DELETE FROM ZTBM_ABXOPVDT
             CLIENT SPECIFIED
             WHERE MANDT EQ SY-MANDT.
      INSERT ZTBM_ABXOPVDT  FROM TABLE LT_AEHD ACCEPTING DUPLICATE KEYS.
      IF SY-SUBRC EQ 0.
        COMMIT WORK.
      ELSE.
        ROLLBACK WORK.
...
*-> Upload except deletion
    WHEN R2.
      MODIFY ZTBM_ABXOPVDT  FROM TABLE LT_AEHD.
      IF SY-SUBRC EQ 0.
        COMMIT WORK.
      ELSE.
        ROLLBACK WORK.
