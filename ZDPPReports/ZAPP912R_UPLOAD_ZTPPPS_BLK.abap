************************************************************************
* Program Name      : ZAPP911R_UPLOAD_ZTPPPS_BLK
* Author            : Bobby
...
* Addl Documentation:
* Description       : 'Upload the data for the table ZTPPPS_BLK
*
* Modification Logs
* Date       Developer    RequestNo    Description
************************************************************************
REPORT ZAPP911R_UPLOAD_ZTPPPS_BLK NO STANDARD PAGE HEADING
...
*&---------------------------------------------------------------------*
*&      Form  UPDATE_ZTPPPS_BLK
*&---------------------------------------------------------------------*
FORM UPDATE_ZTPPPS_BLK    .
  DATA LT_AEHD LIKE ZTPPPS_BLK     OCCURS 0 WITH HEADER LINE.
  LOOP AT IT_AEHD.
...
*-> Upload after all deletion
    WHEN R1.
      DELETE FROM ZTPPPS_BLK
             CLIENT SPECIFIED
             WHERE MANDT EQ SY-MANDT.
      INSERT ZTPPPS_BLK     FROM TABLE LT_AEHD ACCEPTING DUPLICATE KEYS.
      IF SY-SUBRC EQ 0.
        COMMIT WORK.
      ELSE.
        ROLLBACK WORK.
...
*-> Upload except deletion
    WHEN R2.
      MODIFY ZTPPPS_BLK     FROM TABLE LT_AEHD.
      IF SY-SUBRC EQ 0.
        COMMIT WORK.
      ELSE.
        ROLLBACK WORK.
