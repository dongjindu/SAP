************************************************************************
* Program Name      : ZAPP921R_UPLOAD_7JB_B
* Author            : Bobby
...
* Addl Documentation:
* Description       : 'Upload the data for the table ZTPP_PMT07JB_B
*
* Modification Logs
* Date       Developer    RequestNo    Description
************************************************************************
REPORT ZAPP921R_UPLOAD_7JB_B      NO STANDARD PAGE HEADING
...
*&---------------------------------------------------------------------*
*&      Form  UPDATE_ZTPP_PMT07JB_B
*&---------------------------------------------------------------------*
FORM UPDATE_ZTPP_PMT07JB_B.
  DATA LT_AEHD LIKE ZTPP_PMT07JB_B OCCURS 0 WITH HEADER LINE.
  LOOP AT IT_AEHD.
...
*-> Upload after all deletion
    WHEN R1.
      DELETE FROM ZTPP_PMT07JB_B
             CLIENT SPECIFIED
             WHERE MANDT EQ SY-MANDT.
      INSERT ZTPP_PMT07JB_B FROM TABLE LT_AEHD ACCEPTING DUPLICATE KEYS.
      IF SY-SUBRC EQ 0.
        COMMIT WORK.
      ELSE.
        ROLLBACK WORK.
...
*-> Upload except deletion
    WHEN R2.
      MODIFY ZTPP_PMT07JB_B FROM TABLE LT_AEHD.
      IF SY-SUBRC EQ 0.
        COMMIT WORK.
      ELSE.
        ROLLBACK WORK.
