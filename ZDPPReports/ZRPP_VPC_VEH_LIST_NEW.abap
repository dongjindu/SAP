************************************************************************
* Program Name      : ZRPP_VPC_VEH_LIST_new
* Creation Date     :
...
REPORT ZRPP_VPC_VEH_LIST_NEW NO STANDARD PAGE HEADING
                     LINE-SIZE 132
                     LINE-COUNT 64(1)
                     MESSAGE-ID ZMPP.
...
* 'P_RP19_SHOP_DATE'.
*
*  SELECT objek atflv INTO TABLE $it_objek
*    FROM ausp
...
*  LOOP AT $it_objek.
*    $ix = sy-tabix.
*    l_datum =  l_num = $it_objek-atflv.
*    IF w_ucomm = 'OLD'.
*      IF l_datum > c_cg_date.
*        DELETE $it_objek INDEX $ix.
*      ENDIF.
*    ELSEIF w_ucomm = 'NEW'.
*      IF l_datum <= c_cg_date.
*        DELETE $it_objek INDEX $ix.
