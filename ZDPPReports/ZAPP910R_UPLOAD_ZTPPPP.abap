************************************************************************
* Program Name      : ZAPP910R_UPLOAD_ZTPPPP
* Author            : Bobby
...
* Addl Documentation:
* Description       : 'Upload the data for the table ZTPPPP
*
* Modification Logs
* Date       Developer    RequestNo    Description
************************************************************************
REPORT ZAPP910R_UPLOAD_ZTPPPP     NO STANDARD PAGE HEADING
...
*&---------------------------------------------------------------------*
FORM UPDATE_ZTPPPP        .
  DATA LT_AEHD LIKE ZTPPPP         OCCURS 0 WITH HEADER LINE.
  LOOP AT IT_AEHD.
...
*-> Upload after all deletion
    WHEN R1.
      ...
      INSERT ZTPPPP         FROM TABLE LT_AEHD ACCEPTING DUPLICATE KEYS.
      IF SY-SUBRC EQ 0.
        COMMIT WORK.
      ELSE.
        ROLLBACK WORK.
...
*-> Upload except deletion
    WHEN R2.
      MODIFY ZTPPPP         FROM TABLE LT_AEHD.
      IF SY-SUBRC EQ 0.
        COMMIT WORK.
      ELSE.
        ROLLBACK WORK.
