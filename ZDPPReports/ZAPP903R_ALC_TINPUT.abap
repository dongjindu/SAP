************************************************************************
* Program Name      : ZAPP903R_ALC_TINPUT
* Author            : Bobby
...
* 07/21/2005     CHRIS     UD1K916965 Delete the input plan table trim
*                                     reporting point schedule logic to
*                                     reduce the executon time
* 08/03/2005    CHRIS     UD1K917193  Sort the it_7jb_a table
************************************************************************
REPORT  zapp903r_alc_tinput   MESSAGE-ID zmpp.
