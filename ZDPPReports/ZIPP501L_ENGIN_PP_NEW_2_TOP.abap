...
DATA: BEGIN OF it_list OCCURS 0,
        ...
        zmsg(50),
        en_spc15(5),
        plant_cd LIKE zsppep2_rfc-plant_cd,
      END OF it_list.
...
CONTROLS: tb_9000 TYPE TABLEVIEW USING SCREEN 9000.
*----------------------------------------------------------------------*
*  CONSTANS
*----------------------------------------------------------------------*
...
PARAMETERS      r01 RADIOBUTTON GROUP rad0 DEFAULT 'X'.
SELECTION-SCREEN POSITION 7.
SELECTION-SCREEN COMMENT (25) text-011 FOR FIELD r01.
PARAMETERS      r02 RADIOBUTTON GROUP rad0.
SELECTION-SCREEN COMMENT (25) text-012 FOR FIELD r01.
