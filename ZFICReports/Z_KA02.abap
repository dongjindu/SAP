...
parameters: p_kokrs like cskbz-kokrs default 'H201',
            p_upd   as checkbox,
            p_run   as checkbox.
...
*perform open_dataset using dataset.
  ...
  LOOP AT iftab.
    if p_run = 'X'.
      ...
      if p_upd = space.
        perform bdc_field       using 'CSKBZ-DATAB_ANFO'  '01012002'.
      endif.

      perform bdc_field       using 'BDC_OKCODE'   '/00'.
      perform bdc_field       using 'CSKBZ-KOKRS'  p_kokrs.
      ...
      if p_upd = 'X'.
        ...
        perform bdc_field      using 'CSKBZ-KATYP'  '1'.
