FUNCTION Z_FM_GET_MONTHLY_BUDGET_OTH.
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
...
*---// Initialization
  ...
  PERFORM check_rtn.
  PERFORM get_budget_oth.
  PERFORM get_actual_oth.
  PERFORM get_available_oth.
  PERFORM set_blank_cate_oth.
  PERFORM set_text_n_total_oth.
