...
PARAMETERS:
      ...
      cogs_df  LIKE ska1-saknr DEFAULT '0000510009' NO-DISPLAY,
      cogs_ds  LIKE ska1-saknr DEFAULT '0000510109' NO-DISPLAY,
...
PARAMETERS: p_disp(1) TYPE c  DEFAULT '2' NO-DISPLAY.
*&---------------------------------------------------------------------*
...
* check val.class
    ...
    PERFORM calc_cogs.
    it_cogs-va000 = it_cogs-ac000 - it_cogs-sd000.
    COLLECT it_cogs.
  ...
  LOOP AT t_out.
**fix double qty
    READ TABLE it_cogs_sum WITH KEY bklas = t_out-bklas
                                    matnr = t_out-matnr.
    IF sy-subrc = 0. CLEAR: t_out-pbpopo.  ENDIF.
