...
* 6/10/2010   VALERIAN  UD1K949217  Add selection logic based on     *
*                                   'Component' field (defined in    *
*                                   selection-screen)                *
* 7/12/2011   VALERIAN  UD1K952369  Fix bug caused by the versions   *
*                                   selection                        *
*--------------------------------------------------------------------*
...
*--------------------------------------------------------------------*
  ...
  select-options : s_poper for ztco_shop_sum-poper  memory id popr,
                   ...
                   s_matnr for ztco_shop_sum-llv_matnr.    "UD1K949217
...
form get_shop_cost.
  ...
  select  *  into table it_shop_sum
    ...
    where kokrs       =  p_kokrs
      ...
      and llv_matnr   in s_matnr.                          "UD1K949217
