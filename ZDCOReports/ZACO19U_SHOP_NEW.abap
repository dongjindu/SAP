...
* 09/28/2011   KDM          UP1K920005   Change for ECC
*                                        Add logics of a new prefix 'MK'
*                                        change FM 'CO_K_KKB_BEWEG_SET'
*                                            --> 'ZCO_K_KKB_BEWEG_SET'
*                                        Index : KDM01
* 02/06/2012   Valerian     UD1K953911   Skip the material that is not
*                                        found in table 'PPC_COMAT'
************************************************************************
...
*** Change FM(09/28/2011, KDM01)
*** Can't find replacable FM, so I made a new FM.
    call function 'ZCO_K_KKB_BEWEG_SET'
         EXPORTING
...
** : Change Object key structure(09/28/2011, KDM01)
*      l_objnr(2) = 'VS'.
...
*      l_objnr+3 = gs_quantities-sobkz.
      ...
      CALL FUNCTION 'QRP_APO_COMP_OBJNR_DECODE'
           ...
           EXCEPTIONS                                       "UD1K953911
                NOT_FOUND       = 1                         "UD1K953911
                OTHERS          = 2.                        "UD1K953911

      IF sy-subrc <> 0.                                     "UD1K953911
        CONTINUE.                                           "UD1K953911
      ENDIF.                                                "UD1K953911
...
FORM read_wips_di.
  CONSTANTS: con_x TYPE c VALUE 'X',
             ...
             con_obj_mk(2) TYPE c VALUE 'MK',  "" (09/28/2011) KDM01
...
**(09/28/2011) Logic Change(KDM01)
          IF lt_cpzp-f_objnr(2) EQ con_obj_mk.
*------------------------------- Component -----------------------------
