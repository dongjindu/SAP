...
* by Andy
*
* Be careful when you run this program.
* CO specialist have to use...
*
REPORT Z_PPC_WIP_CLEAR LINE-SIZE 300.
TABLES: CKMLHD, AUFK,
...
parameters: p_aufnr like aufk-aufnr OBLIGATORY,
            p_GJPER TYPE CO_GJPER   OBLIGATORY,
            t_GJPER TYPE CO_GJPER   OBLIGATORY.
