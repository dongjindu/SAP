************************************************************************
* Program Name      : ZACO34U_SKF12
* Author            : Eun Hwa , Jung
* Creation Date     : 2003.12.04.
* Specifications By : Jin won, Hong
* Pattern           : Report 1-1
* Development Request No : UD1K904907
* Addl Documentation:
* Description       : Create No of Engines for Engine Shop
...
*======================================================================
*  01/12/2012  Valerian  UD1K953667  HMMA Engine Plant split
*                                    implementation
*----------------------------------------------------------------------

REPORT ZACO34U_SKF12 MESSAGE-ID ZMCO.
...
*      Read table MARA, MARC, ZMKPF_MSEG_V ( MSEG + MKPF )
  CLEAR : IT_MARA, IT_MARA[].
  SELECT A~MATNR A~MTART B~WERKS B~FEVOR
     INTO CORRESPONDING FIELDS OF TABLE IT_MARA
       FROM ( MARA AS A INNER JOIN MARC AS B
               ON A~MATNR = B~MATNR )
          WHERE A~MTART EQ 'HALB'
            AND ( B~WERKS EQ 'E001' OR B~WERKS EQ 'E002' )  "UD1K953667
*           AND B~WERKS EQ 'E001'                           "UD1K953667
            AND B~FEVOR EQ 'SEA'.
    ...
    INTO CORRESPONDING FIELDS OF TABLE IT_MSEG
      FROM ZMKPF_MSEG_V CLIENT SPECIFIED
        ...
        WHERE  MANDT = SY-MANDT
         ...
         AND ( WERKS = 'E001' OR WERKS = 'E002' ).          "UD1K953667
*        AND   WERKS = 'E001'.                              "UD1K953667
  CLEAR IT_MSEG.
...
* send.business process     =  'P4101-55005'
* receiver.business process =  ' DUMMY-PROC'
  ...
  IT_REPORT-SENBUSPROC = 'P4101-55005'.
  IT_REPORT-RECBUSPROC = 'DUMMY-PROC'.
  IT_REPORT-TQTY = QTY.
  APPEND IT_REPORT.

* doc date / posting date   =  ' YEAR/MONTH/28 '
* send.business process     =  'P6207-55005'
* receiver.business process =  ' DUMMY-PROC'
  ...
  CONCATENATE P_GJAHR P_PERID+1(2) '28'
              INTO IT_REPORT-BUDAT.
  IT_REPORT-SENBUSPROC = 'P6207-55005'.
  IT_REPORT-RECBUSPROC = 'DUMMY-PROC'.
  IT_REPORT-TQTY = QTY.
  APPEND IT_REPORT.
