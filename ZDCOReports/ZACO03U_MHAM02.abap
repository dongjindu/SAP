...
*                                  type tables.
* 11/01/11 Valerian  UD1K953265    Enlarge calculation field to prevent
*                                  ABAP Dump
* 11/02/11 Valerian  UD1K953273    Get only attendance hours with
...
* in each record
  ...
  DATA : BEGIN OF it_l_calwsig OCCURS 0,
            ...
            catshours LIKE ztco_mhhrtrans-actqty.           "UD1K953265
*           catshours LIKE catsdb-catshours.                "UD1K953265
...
* LOOP AT it_l_catadd.                                      "UD1K953273
  LOOP AT it_l_catadd WHERE kostl IN pnpkostl.              "UD1K953273
    CLEAR  it_tmp_catsdb.
