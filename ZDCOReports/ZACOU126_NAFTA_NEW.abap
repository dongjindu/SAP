...
DATA g_gt_out LIKE gt_out OCCURS 0 WITH HEADER LINE.
...
PARAMETERS     : p_kokrs LIKE ztco_shop_sum-kokrs OBLIGATORY
                 ...
                 MEMORY ID bdtj,
                 p_poper LIKE ztco_shop_sum-poper NO-DISPLAY.
SELECT-OPTIONS s_poper FOR ztco_shop_sum-poper OBLIGATORY.
...
*--------------------------------------------------------------------*
  ...
  PERFORM fill_text.      " Fill the description for material,vendor,etc
    ...
    APPEND LINES OF gt_out TO g_gt_out.
    __cls gt_out.
