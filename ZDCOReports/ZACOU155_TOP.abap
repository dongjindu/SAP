...
TABLES: ekbz, ekpo, ekbe, sscrfields, ekko, lfa1,
        *ztcou124, ztcou124,ztmm_duty_it,*rbkp, ztmm_duty_hd.
TYPE-POOLS: truxs.
*---------------------------------------------------------------------*
* Data
*---------------------------------------------------------------------*\
...
DATA: BEGIN OF i_bsis OCCURS 0,
          ...
          pstqty LIKE ztcou124-xmenge2,          " Posted Quantity
          pstamt LIKE ztcou124-dmbtr,            " Posted Amount
          pdstamt LIKE ztcou124-dmbtr,           " Posted Amount
...
DATA: BEGIN OF w_i_bsis OCCURS 0,
          matnr  LIKE ztmm_duty_it-matnr,
          entno  LIKE ztmm_duty_it-entno,
         $dst_amt  LIKE bsis-dmbtr,
      END OF w_i_bsis.
...
DATA : BEGIN OF it_row_sum OCCURS 0,
         matnr           LIKE   ekpo-matnr,
         ebeln           LIKE   ekpo-ebeln,
         ebelp(5),
         shkzg           LIKE   ekbz-shkzg,
...
DATA: BEGIN OF it_inv OCCURS 0,
      ...
      pstqty LIKE ztcou124-rmenge,
      pstamt LIKE ztcou124-dmbtr,
      pdstamt LIKE ztcou124-dmbtr,    " Posted Distribute-Amount
      meins LIKE ekpo-meins,
      waers LIKE ekbz-waers,
      dmbtr LIKE ekbz-dmbtr,
...
TYPES: xmenges(13),
       ...
       percents(6),
       pstqty LIKE ztcou124-rmenge,   " Posted Quantity
       pstamt LIKE ztcou124-dmbtr,    " Posted Amount
       pdstamt LIKE ztcou124-dmbtr,

       accamt LIKE ztcou124-dmbtr,   " Acc. Amount - 6/26/2007
       varamt LIKE ztcou124-dmbtr,   " Var. Amount - 6/26/2007
       rev(1),
       END OF ty_calc.
...
DATA : BEGIN OF i_write_off OCCURS 0,
         entno     LIKE ztcou124-entno,
         dmbtr     LIKE ztcou124-dmbtr, "Amount
       END   OF  i_write_off.
