...
*                   - Create No of Persons by Department(Plan)
*
* Modifications Log
* Date   Developer   Request ID    Description
*
************************************************************************
REPORT ZACOU134 MESSAGE-ID ZMCO.
INCLUDE ZACOUI00.
...
TYPES: BEGIN OF TY_ROW_TAB.
        INCLUDE STRUCTURE ZTCOU134.                         "1~12 QTY
TYPES:
       ICON TYPE ICON-ID,
       MSG(30),
       CHK(1).
...
DEFINE TRANS_VALUE.
  IT_PERVALUE-QUANTITY_PER&1  =  $GT_OUT-MEG0&1.
END-OF-DEFINITION.
...
CLASS LCL_EVENT_RECEIVER DEFINITION.
  PUBLIC SECTION.
    ...
    TYPES: ZTCOU134_KEY   TYPE STANDARD TABLE OF ZTCOU134_K,
           ZTCOU134_TABLE TYPE STANDARD TABLE OF ZTCOU134.
      ...
      HANDLE_DATA_CHANGED
         FOR EVENT DATA_CHANGED OF CL_GUI_ALV_GRID
             IMPORTING ER_DATA_CHANGED,
                       GET_DELETED_ROWS
             EXPORTING
                       DELETED_ROWS TYPE ZTCOU134_TABLE,

      REFRESH_DELTA_TABLES.

  PRIVATE SECTION.
    DATA DELETED_ROWS TYPE STANDARD TABLE OF ZTCOU134.
...
* remember deleted lines for saving
  ...
  METHOD UPDATE_DELTA_TABLES.
    ...
    LOOP AT PR_DATA_CHANGED->MT_DELETED_ROWS INTO L_DEL_ROW.
      ...
      ELSE.
        MOVE-CORRESPONDING LS_OUTTAB TO LS_ZTCOU134.
        APPEND LS_ZTCOU134 TO DELETED_ROWS.
      ENDIF.
    ENDLOOP.
  ENDMETHOD.
...
* Fill Object List and Plan Values per Period
  __CLS : IT_INDEXSTRUCTURE, IT_COOBJECT, IT_PERVALUE,IT_TOTVALUE.

  SORT $GT_OUT BY KOSTL.
  ...
  LOOP AT $GT_OUT.
    ...
    AT NEW KOSTL.
      ...
      IT_COOBJECT-COSTCENTER   = $GT_OUT-KOSTL.
      APPEND IT_COOBJECT.
      CLEAR  IT_COOBJECT.
    ENDAT.
...
* Index of Value
    ...
    IT_PERVALUE-STATKEYFIG     = $GT_OUT-SKF.
...
FORM CALL_POST_FM.
  ...
  IF P_TRUN EQ TRUE.
    CALL FUNCTION 'BAPI_COSTACTPLN_CHECKKEYFIGURE'
         EXPORTING
