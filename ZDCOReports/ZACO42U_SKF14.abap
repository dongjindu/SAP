************************************************************************
* Program Name      : ZACO42U_SKF14
* Author            : Eun Hwa , Jung
* Creation Date     : 2003.12.23.
* Specifications By : Jin won, Hong
* Pattern           : Report 1-1
* Development Request No : UD1K905316
* Addl Documentation:
* Description       : Create Planned PM Working Hour
...
REPORT ZACO42U_SKF14 MESSAGE-ID ZMCO.
...
DATA : BEGIN OF IT_REPORT OCCURS 0,
        ...
        TQTY(15)    TYPE P DECIMALS 3,
                "LIKE ZTPM_PMRO-ZPTIME_B,
  ...
  SELECT AJAHR ZMONTH MEINS ZPTIME
         ...
         FROM ZTPM_PMRO
           WHERE AJAHR  EQ P_GJAHR
             AND ZMONTH EQ MONTH
             AND AUART IN ('PM01' ,'PM03', 'PM04', 'PM05')
             AND MEINS NE ' '.
  CLEAR  IT_ZTPM_PMRO.
