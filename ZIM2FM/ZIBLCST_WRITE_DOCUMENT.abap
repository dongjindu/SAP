FUNCTION ZIBLCST_WRITE_DOCUMENT        .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZIBLCST        '
            OBJECTID    = OBJECTID
...
IF UPD_ZTBLCST                        NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTBLCST                       '
                WORKAREA_OLD        = O_ZTBLCST
                WORKAREA_NEW        = N_ZTBLCST
                CHANGE_INDICATOR    = UPD_ZTBLCST
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZIBLCST         NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZIBLCST
