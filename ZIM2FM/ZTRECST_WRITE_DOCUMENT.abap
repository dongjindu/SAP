FUNCTION ZTRECST_WRITE_DOCUMENT        .
...
IF UPD_ZTRECST                        NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING
       TABLENAME              = 'ZTRECST                       '
       WORKAREA_OLD           = O_ZTRECST
       WORKAREA_NEW           = N_ZTRECST
        CHANGE_INDICATOR       = UPD_ZTRECST
        DOCU_DELETE            = ' '
     EXCEPTIONS
       NAMETAB_ERROR          = 1
       OPEN_MISSING           = 2
  ...
  IF UPD_ICDTXT_ZTRECST         NE SPACE.
     CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
       TABLES
         TEXTTABLE              = ICDTXT_ZTRECST
       EXCEPTIONS
         OPEN_MISSING           = 1
