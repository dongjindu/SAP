FUNCTION ZTIMIMG21_WRITE_DOCUMENT      .
...
IF UPD_ZTIMIMG21                      NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING
       TABLENAME              = 'ZTIMIMG21                     '
       WORKAREA_OLD           = O_ZTIMIMG21
       WORKAREA_NEW           = N_ZTIMIMG21
        CHANGE_INDICATOR       = UPD_ZTIMIMG21
        DOCU_DELETE            = ' '
     EXCEPTIONS
       NAMETAB_ERROR          = 1
       OPEN_MISSING           = 2
  ...
  IF UPD_ICDTXT_ZTIMIMG21       NE SPACE.
     CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
       TABLES
         TEXTTABLE              = ICDTXT_ZTIMIMG21
       EXCEPTIONS
         OPEN_MISSING           = 1
