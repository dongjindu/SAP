FUNCTION ZTIDSUSH_WRITE_DOCUMENT       .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTIDSUSH       '
            OBJECTID    = OBJECTID
...
IF UPD_ZTIDSUSH                       NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTIDSUSH                      '
                WORKAREA_OLD        = O_ZTIDSUSH
                WORKAREA_NEW        = N_ZTIDSUSH
                CHANGE_INDICATOR    = UPD_ZTIDSUSH
                DOCU_DELETE         = ' '
