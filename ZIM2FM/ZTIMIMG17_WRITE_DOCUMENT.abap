FUNCTION ZTIMIMG17_WRITE_DOCUMENT      .
...
IF UPD_ZTIMIMG17                      NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING
       TABLENAME              = 'ZTIMIMG17                     '
       WORKAREA_OLD           = O_ZTIMIMG17
       WORKAREA_NEW           = N_ZTIMIMG17
        CHANGE_INDICATOR       = UPD_ZTIMIMG17
        DOCU_DELETE            = ' '
     EXCEPTIONS
       NAMETAB_ERROR          = 1
       OPEN_MISSING           = 2
  ...
  IF UPD_ICDTXT_ZTIMIMG17       NE SPACE.
     CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
       TABLES
         TEXTTABLE              = ICDTXT_ZTIMIMG17
       EXCEPTIONS
         OPEN_MISSING           = 1
