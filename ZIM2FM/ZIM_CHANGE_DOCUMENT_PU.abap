FUNCTION ZIM_CHANGE_DOCUMENT_PU.
*"----------------------------------------------------------------------
*"*"Local interface:
*"  IMPORTING
*"     REFERENCE(UPD_CHNGIND) LIKE  CDPOS-CHNGIND
*"     REFERENCE(N_ZTPUR) LIKE  ZTPUR STRUCTURE  ZTPUR
*"     REFERENCE(O_ZTPUR) LIKE  ZTPUR STRUCTURE  ZTPUR
...
*"----------------------------------------------------------------------
   ...
   CALL FUNCTION 'ZIPUDOC_WRITE_DOCUMENT'
       EXPORTING
            OBJECTID           =    objecid
            TCODE              =    SY-TCODE
            UTIME              =    SY-UZEIT
