FUNCTION ZICCHD_WRITE_DOCUMENT         .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZICCHD         '
            OBJECTID    = OBJECTID
...
IF UPD_ZTIV                           NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTIV                          '
                WORKAREA_OLD        = O_ZTIV
                WORKAREA_NEW        = N_ZTIV
                CHANGE_INDICATOR    = UPD_ZTIV
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZICCHD          NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZICCHD
