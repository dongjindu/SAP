FUNCTION ZIBLIT_WRITE_DOCUMENT         .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZIBLIT         '
            OBJECTID    = OBJECTID
...
IF UPD_ZTBLIT                         NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTBLIT                        '
                WORKAREA_OLD        = O_ZTBLIT
                WORKAREA_NEW        = N_ZTBLIT
                CHANGE_INDICATOR    = UPD_ZTBLIT
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZIBLIT          NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZIBLIT
