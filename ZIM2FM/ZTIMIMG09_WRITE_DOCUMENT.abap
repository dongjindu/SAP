FUNCTION ZTIMIMG09_WRITE_DOCUMENT      .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTIMIMG09      '
            OBJECTID    = OBJECTID
...
IF UPD_ZTIMIMG09                      NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTIMIMG09                     '
                WORKAREA_OLD        = O_ZTIMIMG09
                WORKAREA_NEW        = N_ZTIMIMG09
                CHANGE_INDICATOR    = UPD_ZTIMIMG09
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZTIMIMG09       NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZTIMIMG09
