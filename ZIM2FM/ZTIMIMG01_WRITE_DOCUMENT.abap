FUNCTION ZTIMIMG01_WRITE_DOCUMENT      .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTIMIMG01      '
            OBJECTID    = OBJECTID
...
IF UPD_ZTIMIMG01                      NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTIMIMG01                     '
                WORKAREA_OLD        = O_ZTIMIMG01
                WORKAREA_NEW        = N_ZTIMIMG01
                CHANGE_INDICATOR    = UPD_ZTIMIMG01
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZTIMIMG01       NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZTIMIMG01
