FUNCTION ZTIMIMG02_WRITE_DOCUMENT      .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTIMIMG02      '
            OBJECTID    = OBJECTID
...
IF UPD_ZTIMIMG02                      NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTIMIMG02                     '
                WORKAREA_OLD        = O_ZTIMIMG02
                WORKAREA_NEW        = N_ZTIMIMG02
                CHANGE_INDICATOR    = UPD_ZTIMIMG02
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZTIMIMG02       NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZTIMIMG02
