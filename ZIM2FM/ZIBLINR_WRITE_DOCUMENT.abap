FUNCTION ZIBLINR_WRITE_DOCUMENT        .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZIBLINR        '
            OBJECTID    = OBJECTID
...
IF UPD_ZTBLINR                        NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTBLINR                       '
                WORKAREA_OLD        = O_ZTBLINR
                WORKAREA_NEW        = N_ZTBLINR
                CHANGE_INDICATOR    = UPD_ZTBLINR
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZIBLINR         NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZIBLINR
