FUNCTION ZTTAXBKIT_WRITE_DOCUMENT      .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTTAXBKIT      '
            OBJECTID    = OBJECTID
...
IF UPD_ZTTAXBKIT                      NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTTAXBKIT                     '
                WORKAREA_OLD        = O_ZTTAXBKIT
                WORKAREA_NEW        = N_ZTTAXBKIT
                CHANGE_INDICATOR    = UPD_ZTTAXBKIT
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZTTAXBKIT       NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZTTAXBKIT
