FUNCTION ZILODOC_WRITE_DOCUMENT        .
...
IF UPD_ZTLLCHD                        NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING
       TABLENAME              = 'ZTLLCHD                       '
       WORKAREA_OLD           = O_ZTLLCHD
       WORKAREA_NEW           = N_ZTLLCHD
        CHANGE_INDICATOR       = UPD_ZTLLCHD
        DOCU_DELETE            = ' '
     EXCEPTIONS
       NAMETAB_ERROR          = 1
       OPEN_MISSING           = 2
...
IF UPD_ZTLLCSG23                      NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING
       TABLENAME              = 'ZTLLCSG23                     '
       WORKAREA_OLD           = O_ZTLLCSG23
       WORKAREA_NEW           = N_ZTLLCSG23
        CHANGE_INDICATOR       = UPD_ZTLLCSG23
        DOCU_DELETE            = ' '
     EXCEPTIONS
       NAMETAB_ERROR          = 1
       OPEN_MISSING           = 2
...
IF UPD_ZTREQST                        NE SPACE.
  ...
  IF UPD_ICDTXT_ZILODOC         NE SPACE.
     CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
       TABLES
         TEXTTABLE              = ICDTXT_ZILODOC
       EXCEPTIONS
         OPEN_MISSING           = 1
