FUNCTION ZITTDOC_WRITE_DOCUMENT        .
...
IF UPD_ZTTTHD                         NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING
       TABLENAME              = 'ZTTTHD                        '
       WORKAREA_OLD           = O_ZTTTHD
       WORKAREA_NEW           = N_ZTTTHD
        CHANGE_INDICATOR       = UPD_ZTTTHD
        DOCU_DELETE            = ' '
     EXCEPTIONS
       NAMETAB_ERROR          = 1
       OPEN_MISSING           = 2
  ...
  IF UPD_ICDTXT_ZITTDOC         NE SPACE.
     CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
       TABLES
         TEXTTABLE              = ICDTXT_ZITTDOC
       EXCEPTIONS
         OPEN_MISSING           = 1
