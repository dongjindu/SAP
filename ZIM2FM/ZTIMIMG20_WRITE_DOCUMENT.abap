FUNCTION ZTIMIMG20_WRITE_DOCUMENT      .
...
IF UPD_ZTIMIMG20                      NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING
       TABLENAME              = 'ZTIMIMG20                     '
       WORKAREA_OLD           = O_ZTIMIMG20
       WORKAREA_NEW           = N_ZTIMIMG20
        CHANGE_INDICATOR       = UPD_ZTIMIMG20
        DOCU_DELETE            = ' '
     EXCEPTIONS
       NAMETAB_ERROR          = 1
       OPEN_MISSING           = 2
  ...
  IF UPD_ICDTXT_ZTIMIMG20       NE SPACE.
     CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
       TABLES
         TEXTTABLE              = ICDTXT_ZTIMIMG20
       EXCEPTIONS
         OPEN_MISSING           = 1
