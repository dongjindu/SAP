FUNCTION ZTBSEG_WRITE_DOCUMENT         .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTBSEG         '
            OBJECTID    = OBJECTID
...
IF UPD_ZTBSEG                         NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTBSEG                        '
                WORKAREA_OLD        = O_ZTBSEG
                WORKAREA_NEW        = N_ZTBSEG
                CHANGE_INDICATOR    = UPD_ZTBSEG
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZTBSEG          NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZTBSEG
