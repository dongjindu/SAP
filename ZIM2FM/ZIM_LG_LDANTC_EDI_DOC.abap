FUNCTION ZIM_LG_LDANTC_EDI_DOC.
*"----------------------------------------------------------------------
*"*"Local interface:
*"  IMPORTING
...
*>> 문서의 시작.
     IF W_EDI_RECORD(2) EQ '<<'.
      ...
      ELSE.
*>> 찾지 못했을 경우, CONTINUE.
         IF L_ZFDHDOC EQ 'LDANTC'.       ">선적서류도착통보서.
...
*>> 전자문서 GET!
                     ...
                     WHEN 'REN'.          ">인수증번호.
                        MOVE: W_EDI_RECORD+5(35) TO IT_ZTPMTEDI-ZFISNO.
                        MODIFY IT_ZTPMTHD INDEX W_TABIX.
                     WHEN OTHERS.
                  ENDCASE.

               WHEN '04'.     ">외화어음금액, 원화환산금액.
                  CASE W_EDI_RECORD+2(03).
                     WHEN '2AD'.
                        ...
                        MODIFY IT_ZTPMTHD INDEX W_TABIX.
                     WHEN '2AE'.
                        MOVE:W_EDI_RECORD+5(18) TO IT_ZTPMTEDI-ZFMOA.
                        MOVE:W_EDI_RECORD+23(3) TO IT_ZTPMTEDI-WAERS.
                        PERFORM  SET_CURR_CONV_TO_INTERNAL
                                 CHANGING IT_ZTPMTEDI-ZFMOA
                                          IT_ZTPMTEDI-WAERS.
                        MODIFY IT_ZTPMTHD INDEX W_TABIX.
                     WHEN OTHERS.
                  ENDCASE.
               ...
               WHEN '05'.     ">전신환 매입율.
                  MOVE W_EDI_RECORD+3(12)  TO  IT_ZTPMTEDI-ZFEXRT.
                  MODIFY IT_ZTPMTHD INDEX W_TABIX.
               WHEN '06'.     ">통지일자/최종결제일.
                  CASE W_EDI_RECORD+2(03).
                     WHEN '184'.     ">통지일자.
                     ...
                     WHEN '2AD'.     ">NEGO 일자.
                        CALL FUNCTION 'CONVERT_DATE_TO_INTERNAL'
                             EXPORTING
                                 DATE_EXTERNAL = W_EDI_RECORD+5(06)
                             IMPORTING
                                 DATE_INTERNAL = IT_ZTPMTEDI-NEGODT.
                        MODIFY IT_ZTPMTEDI INDEX W_TABIX.
