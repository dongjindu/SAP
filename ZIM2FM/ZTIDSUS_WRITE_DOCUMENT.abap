FUNCTION ZTIDSUS_WRITE_DOCUMENT        .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTIDSUS        '
            OBJECTID    = OBJECTID
...
IF UPD_ZTIDSUS                        NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTIDSUS                       '
                WORKAREA_OLD        = O_ZTIDSUS
                WORKAREA_NEW        = N_ZTIDSUS
                CHANGE_INDICATOR    = UPD_ZTIDSUS
                DOCU_DELETE         = ' '
