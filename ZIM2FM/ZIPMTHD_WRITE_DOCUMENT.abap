FUNCTION ZIPMTHD_WRITE_DOCUMENT        .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZIPMTHD        '
            OBJECTID    = OBJECTID
...
IF UPD_ZTPMTHD                        NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTPMTHD                       '
                WORKAREA_OLD        = O_ZTPMTHD
                WORKAREA_NEW        = N_ZTPMTHD
                CHANGE_INDICATOR    = UPD_ZTPMTHD
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZIPMTHD         NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZIPMTHD
