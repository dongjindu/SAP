FUNCTION ZTIMIMG00_WRITE_DOCUMENT      .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTIMIMG00      '
            OBJECTID    = OBJECTID
...
IF UPD_ZTIMIMG00                      NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTIMIMG00                     '
                WORKAREA_OLD        = O_ZTIMIMG00
                WORKAREA_NEW        = N_ZTIMIMG00
                CHANGE_INDICATOR    = UPD_ZTIMIMG00
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZTIMIMG00       NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZTIMIMG00
