FUNCTION ZTBLINRTMP_WRITE_DOCUMENT     .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTBLINRTMP     '
            OBJECTID    = OBJECTID
...
IF UPD_ZTBLINR_TMP                    NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTBLINR_TMP                   '
                WORKAREA_OLD        = O_ZTBLINR_TMP
                WORKAREA_NEW        = N_ZTBLINR_TMP
                CHANGE_INDICATOR    = UPD_ZTBLINR_TMP
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZTBLINRTMP      NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZTBLINRTMP
