FUNCTION ZTBWIT_WRITE_DOCUMENT.
*"----------------------------------------------------------------------
...
*"     VALUE(UPD_ICDTXT_ZTBWIT) LIKE  CDPOS-CHNGIND DEFAULT SPACE
*"     VALUE(N_ZTBWIT) LIKE  ZTBWIT STRUCTURE  ZTBWIT
*"     VALUE(O_ZTBWIT) LIKE  ZTBWIT STRUCTURE  ZTBWIT
*"     VALUE(UPD_ZTBWIT) LIKE  CDPOS-CHNGIND DEFAULT SPACE
*"  TABLES
*"      ICDTXT_ZTBWIT STRUCTURE  CDTXT
*"----------------------------------------------------------------------


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTBWIT         '
            OBJECTID    = OBJECTID
...
IF UPD_ZTBWIT                         NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTBWIT                        '
                WORKAREA_OLD        = O_ZTBWIT
                WORKAREA_NEW        = N_ZTBWIT
                CHANGE_INDICATOR    = UPD_ZTBWIT
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZTBWIT       NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZTBWIT
