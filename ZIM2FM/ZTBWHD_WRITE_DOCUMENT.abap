FUNCTION ZTBWHD_WRITE_DOCUMENT.
*"----------------------------------------------------------------------
...
*"       SPACE
*"     VALUE(OBJECT_CHANGE_INDICATOR) LIKE  CDHDR-CHANGE_IND DEFAULT
*"       'U'
*"     VALUE(PLANNED_OR_REAL_CHANGES) LIKE  CDHDR-CHANGE_IND DEFAULT
*"       SPACE
*"     VALUE(NO_CHANGE_POINTERS) LIKE  CDHDR-CHANGE_IND DEFAULT SPACE
*"     VALUE(UPD_ICDTXT_ZTBWHD) LIKE  CDPOS-CHNGIND DEFAULT SPACE
*"     VALUE(N_ZTBWHD) LIKE  ZTBWHD STRUCTURE  ZTBWHD
*"     VALUE(O_ZTBWHD) LIKE  ZTBWHD STRUCTURE  ZTBWHD
*"     VALUE(UPD_ZTBWHD) LIKE  CDPOS-CHNGIND DEFAULT SPACE
*"  TABLES
*"      ICDTXT_ZTBWHD STRUCTURE  CDTXT
*"----------------------------------------------------------------------


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTBWHD         '
            OBJECTID    = OBJECTID
...
IF UPD_ZTBWHD                         NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTBWHD                        '
                WORKAREA_OLD        = O_ZTBWHD
                WORKAREA_NEW        = N_ZTBWHD
                CHANGE_INDICATOR    = UPD_ZTBWHD
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZTBWHD     NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZTBWHD
