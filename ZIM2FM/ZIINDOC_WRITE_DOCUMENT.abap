FUNCTION ZIINDOC_WRITE_DOCUMENT        .
...
IF UPD_ZTINS                          NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING
       TABLENAME              = 'ZTINS                         '
       WORKAREA_OLD           = O_ZTINS
       WORKAREA_NEW           = N_ZTINS
        CHANGE_INDICATOR       = UPD_ZTINS
        DOCU_DELETE            = ' '
     EXCEPTIONS
       NAMETAB_ERROR          = 1
       OPEN_MISSING           = 2
...
IF UPD_ZTINSRSP                       NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING
       TABLENAME              = 'ZTINSRSP                      '
       WORKAREA_OLD           = O_ZTINSRSP
       WORKAREA_NEW           = N_ZTINSRSP
        CHANGE_INDICATOR       = UPD_ZTINSRSP
        DOCU_DELETE            = ' '
     EXCEPTIONS
       NAMETAB_ERROR          = 1
       OPEN_MISSING           = 2
...
IF UPD_ZTINSSG3                       NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING
       TABLENAME              = 'ZTINSSG3                      '
       WORKAREA_OLD           = O_ZTINSSG3
       WORKAREA_NEW           = N_ZTINSSG3
        CHANGE_INDICATOR       = UPD_ZTINSSG3
        DOCU_DELETE            = ' '
     EXCEPTIONS
       NAMETAB_ERROR          = 1
       OPEN_MISSING           = 2
  ...
  IF UPD_ICDTXT_ZIINDOC         NE SPACE.
     CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
       TABLES
         TEXTTABLE              = ICDTXT_ZIINDOC
       EXCEPTIONS
         OPEN_MISSING           = 1
