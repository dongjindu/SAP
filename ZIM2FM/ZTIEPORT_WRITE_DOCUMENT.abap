FUNCTION ZTIEPORT_WRITE_DOCUMENT.
*"----------------------------------------------------------------------
...
*"     VALUE(UPD_ICDTXT_ZTIEPORT) LIKE  CDPOS-CHNGIND DEFAULT SPACE
*"     VALUE(N_ZTIEPORT) LIKE  ZTIEPORT STRUCTURE  ZTIEPORT
*"     VALUE(O_ZTIEPORT) LIKE  ZTIEPORT STRUCTURE  ZTIEPORT
*"     VALUE(UPD_ZTIEPORT) LIKE  CDPOS-CHNGIND DEFAULT SPACE
*"  TABLES
*"      ICDTXT_ZTIEPORT STRUCTURE  CDTXT
*"----------------------------------------------------------------------
...
IF UPD_ZTIEPORT                       NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING
       TABLENAME              = 'ZTIEPORT                      '
       WORKAREA_OLD           = O_ZTIEPORT
       WORKAREA_NEW           = N_ZTIEPORT
        CHANGE_INDICATOR       = UPD_ZTIEPORT
        DOCU_DELETE            = ' '
     EXCEPTIONS
       NAMETAB_ERROR          = 1
       OPEN_MISSING           = 2
  ...
  IF UPD_ICDTXT_ZTIEPORT        NE SPACE.
     CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
       TABLES
         TEXTTABLE              = ICDTXT_ZTIEPORT
       EXCEPTIONS
         OPEN_MISSING           = 1
