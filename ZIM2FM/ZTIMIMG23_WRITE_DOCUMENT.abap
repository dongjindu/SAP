FUNCTION ZTIMIMG23_WRITE_DOCUMENT.
*"----------------------------------------------------------------------
...
*"     VALUE(UPD_ICDTXT_ZTIMIMG23) LIKE  CDPOS-CHNGIND DEFAULT SPACE
*"     VALUE(N_ZTIMIMG23) LIKE  ZTIMIMG23 STRUCTURE  ZTIMIMG23
*"     VALUE(O_ZTIMIMG23) LIKE  ZTIMIMG23 STRUCTURE  ZTIMIMG23
*"     VALUE(UPD_ZTIMIMG23) LIKE  CDPOS-CHNGIND DEFAULT SPACE
*"  TABLES
*"      ICDTXT_ZTIMIMG23 STRUCTURE  CDTXT
*"----------------------------------------------------------------------
...
IF UPD_ZTIMIMG23                      NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING
       TABLENAME              = 'ZTIMIMG23                     '
       WORKAREA_OLD           = O_ZTIMIMG23
       WORKAREA_NEW           = N_ZTIMIMG23
        CHANGE_INDICATOR       = UPD_ZTIMIMG23
        DOCU_DELETE            = ' '
     EXCEPTIONS
       NAMETAB_ERROR          = 1
       OPEN_MISSING           = 2
  ...
  IF UPD_ICDTXT_ZTIMIMG23       NE SPACE.
     CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
       TABLES
         TEXTTABLE              = ICDTXT_ZTIMIMG23
       EXCEPTIONS
         OPEN_MISSING           = 1
