FUNCTION ZIPMTIV_WRITE_DOCUMENT        .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZIPMTIV        '
            OBJECTID    = OBJECTID
...
IF UPD_ZTPMTIV                        NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTPMTIV                       '
                WORKAREA_OLD        = O_ZTPMTIV
                WORKAREA_NEW        = N_ZTPMTIV
                CHANGE_INDICATOR    = UPD_ZTPMTIV
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZIPMTIV         NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZIPMTIV
