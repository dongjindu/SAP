FUNCTION ZIBLOUR_WRITE_DOCUMENT        .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZIBLOUR        '
            OBJECTID    = OBJECTID
...
IF UPD_ZTBLOUR                        NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTBLOUR                       '
                WORKAREA_OLD        = O_ZTBLOUR
                WORKAREA_NEW        = N_ZTBLOUR
                CHANGE_INDICATOR    = UPD_ZTBLOUR
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZIBLOUR         NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZIBLOUR
