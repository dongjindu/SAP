FUNCTION ZTIDRUSH_WRITE_DOCUMENT       .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTIDRUSH       '
            OBJECTID    = OBJECTID
...
IF UPD_ZTIDRUSH                       NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTIDRUSH                      '
                WORKAREA_OLD        = O_ZTIDRUSH
                WORKAREA_NEW        = N_ZTIDRUSH
                CHANGE_INDICATOR    = UPD_ZTIDRUSH
                DOCU_DELETE         = ' '
