FUNCTION ZICGHD_WRITE_DOCUMENT         .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZICGHD         '
            OBJECTID    = OBJECTID
...
IF UPD_ZTCGHD                         NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTCGHD                        '
                WORKAREA_OLD        = O_ZTCGHD
                WORKAREA_NEW        = N_ZTCGHD
                CHANGE_INDICATOR    = UPD_ZTCGHD
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZICGHD          NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZICGHD
