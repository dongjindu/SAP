FUNCTION ZTIMIMG04_WRITE_DOCUMENT      .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTIMIMG04      '
            OBJECTID    = OBJECTID
...
IF UPD_ZTIMIMG04                      NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTIMIMG04                     '
                WORKAREA_OLD        = O_ZTIMIMG04
                WORKAREA_NEW        = N_ZTIMIMG04
                CHANGE_INDICATOR    = UPD_ZTIMIMG04
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZTIMIMG04       NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZTIMIMG04
