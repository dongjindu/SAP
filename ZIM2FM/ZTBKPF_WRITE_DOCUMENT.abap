FUNCTION ZTBKPF_WRITE_DOCUMENT         .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTBKPF         '
            OBJECTID    = OBJECTID
...
IF UPD_ZTBKPF                         NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTBKPF                        '
                WORKAREA_OLD        = O_ZTBKPF
                WORKAREA_NEW        = N_ZTBKPF
                CHANGE_INDICATOR    = UPD_ZTBKPF
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZTBKPF          NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZTBKPF
