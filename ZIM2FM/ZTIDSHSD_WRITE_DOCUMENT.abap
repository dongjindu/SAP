FUNCTION ZTIDSHSD_WRITE_DOCUMENT       .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTIDSHSD       '
            OBJECTID    = OBJECTID
...
IF UPD_ZTIDSHSD                       NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTIDSHSD                      '
                WORKAREA_OLD        = O_ZTIDSHSD
                WORKAREA_NEW        = N_ZTIDSHSD
                CHANGE_INDICATOR    = UPD_ZTIDSHSD
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZTIDSHSD        NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZTIDSHSD
