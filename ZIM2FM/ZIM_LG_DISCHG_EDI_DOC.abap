FUNCTION ZIM_LG_DISCHG_EDI_DOC.
*"----------------------------------------------------------------------
*"*"Local interface:
*"  IMPORTING
...
*>> 문서의 시작.
     IF W_EDI_RECORD(2) EQ '<<'.
      ...
      ELSE.
*>> 찾지 못했을 경우, CONTINUE.
         IF L_ZFDHDOC EQ 'DISCHG'.    ">수입어음 DISCOUNT 내역통보서.
...
*>> 전자문서 GET!
               ...
               WHEN '04'.     ">어음금액/기타 수수료..
                  CASE W_EDI_RECORD+2(03).
                     ...
                     WHEN '26'.    ">할인수수료.
                       MOVE: W_EDI_RECORD+5(18) TO IT_ZTPMTEDI-ZFUSIT,
                             W_EDI_RECORD+23(3) TO IT_ZTPMTEDI-ZFUSITC.

                        PERFORM SET_CURR_CONV_TO_INTERNAL
                                CHANGING  IT_ZTPMTEDI-ZFUSIT
                                          IT_ZTPMTEDI-ZFUSITC.

                     WHEN '304'.   ">기타수수료.
                        MOVE:W_EDI_RECORD+5(18) TO IT_ZTPMTEDI-ZFBKCH,
                             W_EDI_RECORD+23(3) TO IT_ZTPMTEDI-ZFBKCHC.
                        PERFORM  SET_CURR_CONV_TO_INTERNAL
                                 CHANGING IT_ZTPMTEDI-ZFBKCH
                                          IT_ZTPMTEDI-ZFBKCHC.

*                     WHEN '17'.   ">합계.
*                      MOVE : W_EDI_RECORD+5(18) TO IT_ZTPMTHD-ZFTIVAM,
*                             W_EDI_RECORD+23(3) TO IT_ZTPMTHD-ZFSCUR.
*                       PERFORM  SET_CURR_CONV_TO_INTERNAL
*                                CHANGING  IT_ZTPMTHD-ZFTIVAM
*                                          IT_ZTPMTHD-ZFSCUR.
                     WHEN OTHERS.
                  ENDCASE.
                  MODIFY IT_ZTPMTEDI INDEX W_TABIX.
               ...
               WHEN '05'.
                  MOVE W_EDI_RECORD+5(8)  TO  IT_ZTPMTEDI-ZFUSITR.
                  MODIFY IT_ZTPMTEDI INDEX W_TABIX.
                     ...
                     WHEN '154'.     ">할인일.
                        CALL FUNCTION 'CONVERT_DATE_TO_INTERNAL'
                             EXPORTING
                                 DATE_EXTERNAL = W_EDI_RECORD+5(06)
                             IMPORTING
                                 DATE_INTERNAL = IT_ZTPMTEDI-ZFDSDT.

                  ENDCASE.
                  MODIFY IT_ZTPMTEDI INDEX W_TABIX.

               WHEN '07'.   ">기타사항.
                  MOVE : W_EDI_RECORD+5(70)   TO  IT_ZTPMTEDI-ZFRMK1,
