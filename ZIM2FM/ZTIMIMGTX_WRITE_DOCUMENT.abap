FUNCTION ZTIMIMGTX_WRITE_DOCUMENT      .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTIMIMGTX      '
            OBJECTID    = OBJECTID
...
IF UPD_ZTIMIMGTX                      NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTIMIMGTX                     '
                WORKAREA_OLD        = O_ZTIMIMGTX
                WORKAREA_NEW        = N_ZTIMIMGTX
                CHANGE_INDICATOR    = UPD_ZTIMIMGTX
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZTIMIMGTX       NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZTIMIMGTX
