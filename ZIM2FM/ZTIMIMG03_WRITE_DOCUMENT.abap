FUNCTION ZTIMIMG03_WRITE_DOCUMENT      .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTIMIMG03      '
            OBJECTID    = OBJECTID
...
IF UPD_ZTIMIMG03                      NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTIMIMG03                     '
                WORKAREA_OLD        = O_ZTIMIMG03
                WORKAREA_NEW        = N_ZTIMIMG03
                CHANGE_INDICATOR    = UPD_ZTIMIMG03
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZTIMIMG03       NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZTIMIMG03
