FUNCTION ZTIMIMG10_WRITE_DOCUMENT      .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTIMIMG10      '
            OBJECTID    = OBJECTID
...
IF UPD_ZTIMIMG10                      NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTIMIMG10                     '
                WORKAREA_OLD        = O_ZTIMIMG10
                WORKAREA_NEW        = N_ZTIMIMG10
                CHANGE_INDICATOR    = UPD_ZTIMIMG10
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZTIMIMG10       NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZTIMIMG10
