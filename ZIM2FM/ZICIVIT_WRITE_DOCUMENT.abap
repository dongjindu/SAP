FUNCTION ZICIVIT_WRITE_DOCUMENT        .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZICIVIT        '
            OBJECTID    = OBJECTID
...
IF UPD_ZTCIVIT                        NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTCIVIT                       '
                WORKAREA_OLD        = O_ZTCIVIT
                WORKAREA_NEW        = N_ZTCIVIT
                CHANGE_INDICATOR    = UPD_ZTCIVIT
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZICIVIT         NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZICIVIT
