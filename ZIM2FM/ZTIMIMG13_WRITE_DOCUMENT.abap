FUNCTION ZTIMIMG13_WRITE_DOCUMENT      .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTIMIMG13      '
            OBJECTID    = OBJECTID
...
IF UPD_ZTIMIMG13                      NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTIMIMG13                     '
                WORKAREA_OLD        = O_ZTIMIMG13
                WORKAREA_NEW        = N_ZTIMIMG13
                CHANGE_INDICATOR    = UPD_ZTIMIMG13
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZTIMIMG13       NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZTIMIMG13
