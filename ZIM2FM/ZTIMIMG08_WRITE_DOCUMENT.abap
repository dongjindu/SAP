FUNCTION ZTIMIMG08_WRITE_DOCUMENT      .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTIMIMG08      '
            OBJECTID    = OBJECTID
...
IF UPD_ZTIMIMG08                      NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTIMIMG08                     '
                WORKAREA_OLD        = O_ZTIMIMG08
                WORKAREA_NEW        = N_ZTIMIMG08
                CHANGE_INDICATOR    = UPD_ZTIMIMG08
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZTIMIMG08       NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZTIMIMG08
