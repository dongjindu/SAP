FUNCTION ZTIDS_WRITE_DOCUMENT          .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTIDS          '
            OBJECTID    = OBJECTID
...
IF UPD_ZTIDS                          NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTIDS                         '
                WORKAREA_OLD        = O_ZTIDS
                WORKAREA_NEW        = N_ZTIDS
                CHANGE_INDICATOR    = UPD_ZTIDS
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZTIDS           NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZTIDS
