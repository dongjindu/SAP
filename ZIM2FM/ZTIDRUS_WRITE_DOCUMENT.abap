FUNCTION ZTIDRUS_WRITE_DOCUMENT        .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTIDRUS        '
            OBJECTID    = OBJECTID
...
IF UPD_ZTIDRUS                        NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTIDRUS                       '
                WORKAREA_OLD        = O_ZTIDRUS
                WORKAREA_NEW        = N_ZTIDRUS
                CHANGE_INDICATOR    = UPD_ZTIDRUS
                DOCU_DELETE         = ' '
