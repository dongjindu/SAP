FUNCTION ZILOADOC_WRITE_DOCUMENT       .
...
IF UPD_ZTLLCAMHD                      NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING
       TABLENAME              = 'ZTLLCAMHD                     '
       WORKAREA_OLD           = O_ZTLLCAMHD
       WORKAREA_NEW           = N_ZTLLCAMHD
        CHANGE_INDICATOR       = UPD_ZTLLCAMHD
        DOCU_DELETE            = ' '
     EXCEPTIONS
       NAMETAB_ERROR          = 1
       OPEN_MISSING           = 2
...
IF UPD_ZTREQST                        NE SPACE.
  ...
  IF UPD_ICDTXT_ZILOADOC        NE SPACE.
     CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
       TABLES
         TEXTTABLE              = ICDTXT_ZILOADOC
       EXCEPTIONS
         OPEN_MISSING           = 1
