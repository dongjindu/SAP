FUNCTION ZTIMIMG07_WRITE_DOCUMENT      .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTIMIMG07      '
            OBJECTID    = OBJECTID
...
IF UPD_ZTIMIMG07                      NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTIMIMG07                     '
                WORKAREA_OLD        = O_ZTIMIMG07
                WORKAREA_NEW        = N_ZTIMIMG07
                CHANGE_INDICATOR    = UPD_ZTIMIMG07
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZTIMIMG07       NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZTIMIMG07
