FUNCTION ZTIMIMG22_WRITE_DOCUMENT      .
...
IF UPD_ZTIMIMG22                      NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING
       TABLENAME              = 'ZTIMIMG22                     '
       WORKAREA_OLD           = O_ZTIMIMG22
       WORKAREA_NEW           = N_ZTIMIMG22
        CHANGE_INDICATOR       = UPD_ZTIMIMG22
        DOCU_DELETE            = ' '
     EXCEPTIONS
       NAMETAB_ERROR          = 1
       OPEN_MISSING           = 2
  ...
  IF UPD_ICDTXT_ZTIMIMG22       NE SPACE.
     CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
       TABLES
         TEXTTABLE              = ICDTXT_ZTIMIMG22
       EXCEPTIONS
         OPEN_MISSING           = 1
