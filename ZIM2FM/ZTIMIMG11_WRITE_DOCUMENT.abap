FUNCTION ZTIMIMG11_WRITE_DOCUMENT      .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTIMIMG11      '
            OBJECTID    = OBJECTID
...
IF UPD_ZTIMIMG11                      NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTIMIMG11                     '
                WORKAREA_OLD        = O_ZTIMIMG11
                WORKAREA_NEW        = N_ZTIMIMG11
                CHANGE_INDICATOR    = UPD_ZTIMIMG11
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZTIMIMG11       NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZTIMIMG11
