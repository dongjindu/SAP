FUNCTION ZICGIT_WRITE_DOCUMENT         .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZICGIT         '
            OBJECTID    = OBJECTID
...
IF UPD_ZTCGIT                         NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTCGIT                        '
                WORKAREA_OLD        = O_ZTCGIT
                WORKAREA_NEW        = N_ZTCGIT
                CHANGE_INDICATOR    = UPD_ZTCGIT
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZICGIT          NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZICGIT
