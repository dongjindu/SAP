FUNCTION ZTIDSHS_WRITE_DOCUMENT        .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTIDSHS        '
            OBJECTID    = OBJECTID
...
IF UPD_ZTIDSHS                        NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTIDSHS                       '
                WORKAREA_OLD        = O_ZTIDSHS
                WORKAREA_NEW        = N_ZTIDSHS
                CHANGE_INDICATOR    = UPD_ZTIDSHS
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZTIDSHS         NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZTIDSHS
