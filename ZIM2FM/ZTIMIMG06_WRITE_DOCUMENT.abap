FUNCTION ZTIMIMG06_WRITE_DOCUMENT      .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTIMIMG06      '
            OBJECTID    = OBJECTID
...
IF UPD_ZTIMIMG06                      NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTIMIMG06                     '
                WORKAREA_OLD        = O_ZTIMIMG06
                WORKAREA_NEW        = N_ZTIMIMG06
                CHANGE_INDICATOR    = UPD_ZTIMIMG06
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZTIMIMG06       NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZTIMIMG06
