FUNCTION ZTCCIT_WRITE_DOCUMENT         .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTCCIT         '
            OBJECTID    = OBJECTID
...
IF UPD_ZTCCIT                         NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTCCIT                        '
                WORKAREA_OLD        = O_ZTCCIT
                WORKAREA_NEW        = N_ZTCCIT
                CHANGE_INDICATOR    = UPD_ZTCCIT
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZTCCIT          NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZTCCIT
