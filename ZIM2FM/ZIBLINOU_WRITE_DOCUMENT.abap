FUNCTION ZIBLINOU_WRITE_DOCUMENT       .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZIBLINOU       '
            OBJECTID    = OBJECTID
...
IF UPD_ZTBLINOU                       NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTBLINOU                      '
                WORKAREA_OLD        = O_ZTBLINOU
                WORKAREA_NEW        = N_ZTBLINOU
                CHANGE_INDICATOR    = UPD_ZTBLINOU
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZIBLINOU        NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZIBLINOU
