FUNCTION ZTIDSUSD_WRITE_DOCUMENT       .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTIDSUSD       '
            OBJECTID    = OBJECTID
...
IF UPD_ZTIDSUSD                       NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTIDSUSD                      '
                WORKAREA_OLD        = O_ZTIDSUSD
                WORKAREA_NEW        = N_ZTIDSUSD
                CHANGE_INDICATOR    = UPD_ZTIDSUSD
                DOCU_DELETE         = ' '
