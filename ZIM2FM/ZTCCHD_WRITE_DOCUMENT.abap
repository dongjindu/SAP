FUNCTION ZTCCHD_WRITE_DOCUMENT         .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTCCHD         '
            OBJECTID    = OBJECTID
...
IF UPD_ZTCCHD                         NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTCCHD                        '
                WORKAREA_OLD        = O_ZTCCHD
                WORKAREA_NEW        = N_ZTCCHD
                CHANGE_INDICATOR    = UPD_ZTCCHD
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZTCCHD          NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZTCCHD
