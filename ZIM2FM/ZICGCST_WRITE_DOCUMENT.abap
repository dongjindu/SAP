FUNCTION ZICGCST_WRITE_DOCUMENT        .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZICGCST        '
            OBJECTID    = OBJECTID
...
IF UPD_ZTCGCST                        NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTCGCST                       '
                WORKAREA_OLD        = O_ZTCGCST
                WORKAREA_NEW        = N_ZTCGCST
                CHANGE_INDICATOR    = UPD_ZTCGCST
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZICGCST         NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZICGCST
