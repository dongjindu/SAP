FUNCTION ZTTAXBKHD_WRITE_DOCUMENT      .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZTTAXBKHD      '
            OBJECTID    = OBJECTID
...
IF UPD_ZTTAXBKHD                      NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTTAXBKHD                     '
                WORKAREA_OLD        = O_ZTTAXBKHD
                WORKAREA_NEW        = N_ZTTAXBKHD
                CHANGE_INDICATOR    = UPD_ZTTAXBKHD
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZTTAXBKHD       NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZTTAXBKHD
