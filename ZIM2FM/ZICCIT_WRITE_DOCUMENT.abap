FUNCTION ZICCIT_WRITE_DOCUMENT         .


CALL FUNCTION 'CHANGEDOCUMENT_OPEN'
  EXPORTING OBJECTCLASS = 'ZICCIT         '
            OBJECTID    = OBJECTID
...
IF UPD_ZTIVIT                         NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_SINGLE_CASE'
     EXPORTING  TABLENAME           = 'ZTIVIT                        '
                WORKAREA_OLD        = O_ZTIVIT
                WORKAREA_NEW        = N_ZTIVIT
                CHANGE_INDICATOR    = UPD_ZTIVIT
                DOCU_DELETE         = ' '
...
IF UPD_ICDTXT_ZICCIT          NE SPACE.
   CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
     TABLES    TEXTTABLE  = ICDTXT_ZICCIT
