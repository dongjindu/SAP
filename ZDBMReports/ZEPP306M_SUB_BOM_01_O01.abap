...
*----------------------------------------------------------------------*
MODULE DISPLAY OUTPUT.
  MOVE-CORRESPONDING IT_UPGV TO ZSBM_MODEL_VALS_01.
  PERFORM READ_MAKT.
...
MODULE MODIFY_SCREEN OUTPUT.
  CASE ZMODE.
    ...
    WHEN 'CHANGE'.
      LOOP AT SCREEN.
        CASE SCREEN-NAME.
          WHEN 'ZSBM_MODEL_VALS_01-WERKS' OR
...
*&---------------------------------------------------------------------*
MODULE DISPLAY_9100 OUTPUT.
  MOVE-CORRESPONDING IT_MODL_VAL TO ZTBM_MODEL_VAL_N.
