...
* INTERNAL-TABLE AREA
*----------------------------------------------------------------------*
DATA IT_AMMC TYPE ZTBM_ABXMMCDT OCCURS 0 WITH HEADER LINE.
...
PARAMETERS: P_ZEDAT LIKE ZTBM_ABXMMCDT-ZEDAT,
            P_ZBTIM LIKE ZTBM_ABXMMCDT-ZBTIM.
