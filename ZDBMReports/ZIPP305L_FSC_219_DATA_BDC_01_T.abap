...
*----------------------------------------------------------------------*
TABLES: ztbm_abyalcdt,ztpp_pmt03bb.
*----------------------------------------------------------------------*
* INTERNAL-TABLE AREA
*----------------------------------------------------------------------*
DATA: it_aalc TYPE ztbm_abyalcdt OCCURS 0 WITH HEADER LINE.
...
DATA: BEGIN OF it_excl OCCURS 0,
        ...
        zalcd TYPE ztbm_abyalcdt-alcd,                      "219 CODE
        zdesc TYPE stko-stktx,  "ALTERNATIVE BOM TEXT
        zupct TYPE ztbm_abyalcdt-upct, " CONT.TYPE
        msgty TYPE sy-msgty,
...
PARAMETERS:
  p_zedat LIKE ztbm_abyalcdt-zedat DEFAULT sy-datum,
  p_zbtim LIKE ztbm_abyalcdt-zbtim.
