...
*       COMPONENT CHECK
  ...
  FORMAT COLOR COL_HEADING INTENSIFIED OFF.
  WRITE: / 'Material number CHECK TOTAL LINES : ', WA_LINE_IDX.
  WRITE: / 'Material number does not exist ERROR : ', L_ERRO_MAT.
  FORMAT COLOR OFF.
...
FORM TABLE_CHANGE_BADY USING    PA_BMCO STRUCTURE WA_BMCO.
  ...
  PERFORM DYNPRO USING:
     ...
     ' ' 'ZSEQU'       PA_BMCO-SEQC,    "SEQUENCE NO
     ' ' 'ZUPGN'       PA_BMCO-UPGN,    "UPG
*     ' ' 'ZINFO'       PA_BMCO-ZINFO,    "INFO
     ' ' 'BDC_OKCODE'  '/00',
