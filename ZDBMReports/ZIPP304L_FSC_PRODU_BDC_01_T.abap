...
*----------------------------------------------------------------------*
TABLES: ZTBM_ABYLFPDT.
*----------------------------------------------------------------------*
* INTERNAL-TABLE AREA
*----------------------------------------------------------------------*
DATA: IT_ALFP TYPE ZTBM_ABYLFPDT OCCURS 0 WITH HEADER LINE.
DATA: BEGIN OF IT_ROUT OCCURS 0.
       INCLUDE STRUCTURE ZTBM_ABYLFPDT.
...
PARAMETERS:
  P_ZEDAT LIKE ZTBM_ABYLFPDT-ZEDAT DEFAULT SY-DATUM,
