************************************************************************
* Program Name      : Z_FSD_VEHICLE_VPC_I18
* Author            : HONG KI KIM
...
* Addl Documentation:
* Description       : Z_FSD_VEHICLE_VPC_I18
*
* Modification Logs
...
*
************************************************************************
FUNCTION Z_FSD_VEHICLE_VPC_I18.
*"----------------------------------------------------------------------
*"*"Local interface:
*"  TABLES
*"      ITAB STRUCTURE  ZTSD_VPC_INF_I18
...
*  MODIFY ZTSD_VPC_INF_I18 FROM TABLE ITAB.
*
*  IF SY-SUBRC = 0.
