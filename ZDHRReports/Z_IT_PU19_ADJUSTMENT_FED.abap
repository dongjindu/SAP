...
perform bdc_field       using 'QPU24-TAXAU(01)'
                              'FED'.
perform bdc_field       using 'QPU24-TAXAU(03)'
                              'FED'.
perform bdc_field       using 'QPU24-TAXAU(05)'
                              'FED'.
perform bdc_field       using 'QPU24-WKSIT(01)'
                              '01'.
perform bdc_field       using 'QPU24-WKSIT(03)'
                              '01'.
perform bdc_field       using 'QPU24-WKSIT(05)'
                              '01'.
perform bdc_field       using 'QPU24-TBETR(01)'
                              it_data-amt1.
perform bdc_field       using 'QPU24-TBETR(03)'
                              it_data-amt3.
perform bdc_field       using 'QPU24-TBETR(05)'
                              it_data-amt5.
perform bdc_field       using 'QPU24-TAXBT(01)'
                              it_data-amt2.
perform bdc_field       using 'QPU24-TAXBT(03)'
                              it_data-amt4.
perform bdc_field       using 'QPU24-TAXBT(05)'
                              it_data-amt6.
