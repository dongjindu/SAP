report zhr_401k_empr_contri_report line-size 250 .
* TCODE - ZER401K
**********************************************************************
*Date        Developer    Request        Description
*04/13/2007  Manju       UD1K940313      401K Employee Contribution *
*                                        Report
*04/16/2007  Manju       UD1K940338      Program changes
*04/17/2007  Manju       UD1K940401      Add Employment status
*04/24/2007  Manju       UD1K940413      Add Termination Date for
*                                        withdrawn employees / Show
*                                        records even if  there is
*                                        NO EMPR contribution
*04/30/2007  Manju       UD1K940451      Add 401K Eligibility Date &
*                                        calculate difference only after
*                                        employee 401K eligibility date
*                                        starts.
*05/02/2007  Manju       UD1K940463      Change sign for EE 401K amount
*                                        401C amount
*05/07/2007  Manju       UD1K940484      Create Exception list for the
*                                        employee without 401K
*                                        eligibility date (only in BG)
*05/09/2007  Manju       UD1K940516      Add gross salary & Hire date
*                                        to Report
*05/10/2007  Manju       UD1K940520      Add termination date / 401K
*                                        Employer contribution Date
*                                        Show only 401K Enrolled option
*                                        / Fiscal yearwise difference
*                                        break up
* 05/15/2007 Manju       UD1K940550      Add option to display all
*                                        records for that employee
*                                        with difference
* 06/25/07   Manju       UD1K940883      Add SSN number to Report
* 06/26/2007 manju       UD1K940912      Optimize column width
*
*
* 07/26/2007 IG.Moon     UD1K941129      Add a option for reporting
*                                        previous data.
*                                        Add a option for collecting.
* 07/30/2007 IG.Moon     UD1K941143      Add a column for actual when
*                                        previous reporting
* 07/31/2007 IG.Moon     UD1K941172      Change eligibility period to
*                                        between begin ~ end date.
* 08/05/2007 IG.Moon     UD1K941217      Use the latest old records
*                                        instead of previous records
*                                        when previous reporting.
* 08/08/2007 IG.Moon     UD1K941240      Use the previous
*                                        last period amount =
*                       diff_total until last pay period - erpaid
*
* 08/13/2007 IG.Moon     UD1K941282      Get the for-period for previous
*                                        and then, display data by
*                                        seperated logic retro and
*                                        none-retro at certain period
* 08/15/2007 IG.Moon     UD1K941341      Create each record at the view
*                                        point of previous time
* 06/21/2011 Valerian    UD1K952165      Change the logic of benefit
*                                        calculation
* 10/18/2011 KDM         UP1K930010      REFRESH lt_rgdir. "" ADD KDM01
...
** Select Employee contribution percentage from infotype PA0169
*        select single * from PA0169 where PERNR =  it_tab-pernr and
*                                          SUBTY =  '401K'  and
*                                          ENDDA >=  ws_rgdir-FPEND.
*        if sy-subrc ne 0 or PA0169-EEPCT eq 0 .
** if contribution percenatge is changed within  payroll period
*          select single * from PA0169 where PERNR =  it_tab-pernr and
*                                             SUBTY =  '401K'  and
*              ENDDA between ws_rgdir-FPBEG and  ws_rgdir-FPEND.
*        endif.
*        if sy-subrc eq 0 .
*          it_output-EE% = PA0169-EEPCT.      " Employee Percentage
*        endif.
*      else.
**                     l_ee% = PA0169-EEPCT.
*        clear it_output-EE%.      " Employee Percentage
...
*// 2011.08.10 change by YN.Kim for ecc6.0
