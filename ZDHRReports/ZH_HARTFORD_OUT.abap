...
*10/18/11  KDM              UP1K930010  Systax error correct Index : KDM01)
*                                       day_psp --> day_psp2.
...
DATA day_psp2 LIKE PDSPPSP OCCURS 0 WITH HEADER LINE.  "KDM01
...
*     IM_READ_NO_LOCKED_RECORDS       =
      TABLES
        pernr_tab                       = pdpnr
        psp                             = pdpsp
*// 2011.10.17 changed by KDM  for ECC6.
        day_psp                         = day_psp2  " KDM01
*        day_psp                         = day_psp
*   EXCEPTIONS
...
*    UNPACK w_ansal_nodec   TO rec_01-comp_amt.
  ...
  ELSEIF
    ...
    AND ( pa0008-trfgb = 'H4' OR
          pa0008-trfgb = 'H5' ). ""OR )."(10/17/2011) Change KDM01
...
************************************************************************
** : remark for test(10/17/2011 KDM01) --> unremark(10/20/2011)
