************************************************************************
* Program Name      : SAPMZRQM05R_EQUIP_LIST
...
*-- / Double Click
  METHOD HANDLE_DOUBLE_CLICK.
    DATA: LW_ZSQM_EQ_CLASS LIKE LINE OF IT_ZSQM_EQ_CLASS.
...
*-----------------------------------------------------------------
    ...
    CASE WA_LEVEL.
      WHEN C_CLASS OR C_CHARACTERISTIC.
