************************************************************************
* Program Name      : ZRQM_RQMELL30
* Creation Date     : 03/10/2008
* Development Request No :
* Addl Documentation:
* Description       : Scrap Report
*
* Modification Logs
...
PARAMETERS :  PARNR_IN LIKE LFA1-LIFNR.  "IHPA-PARNR.
PARAMETERS :  P_WERKS LIKE QMFE-WERKS.
** End of change
SELECTION-SCREEN SKIP.
...
*                 WITH VARIANT = VARIANT
  ...
  LOOP AT OBJECT_TAB.
    IF OBJECT_TAB-MAWERK = P_WERKS OR P_WERKS IS INITIAL.
