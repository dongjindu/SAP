...
data: w_qmnum like qmel-qmnum,
      w_matnr1 like viqmel-matnr,
      w_rkmng(13) type c,
      w_erfmg(13) type c.
...
*        w_pkkey = wa_intab-value.
      when 'QMEL-QMNUM'.
        w_qmnum = wa_intab-value.
*      when 'PKHD-PKNUM'.
*        w_pknum = wa_intab-value.
       when 'VIQMEL-MATNR'.
        w_matnr1 = wa_intab-value.
*      when 'KARTE-MATNR'.
*        w_matnr = wa_intab-value.
        when 'VIQMEL-RKMNG'.
        w_rkmng = wa_intab-value.
...
concatenate c_spl_char1 w_qmnum c_spl_char2 w_matnr1
              c_spl_char3 w_rkmng c_spl_char4 w_erfmg
               into w_pdfbc.
