...
REPORT ZCQM10C_EQUIPMENT_CREATE   NO STANDARD PAGE HEADING
...
DATA: BEGIN OF IT_EQUI OCCURS 0,
       ...
       BRGEW  TYPE OBJ_WEIGHT, "/Weight of object
       ...
       ANSWT  TYPE ANSWT, "/Acquisition value
...
**** Number of Equipment to be Created (Initial => Internal Assignment)
    MOVE :
     ...
     IT_EQUI-EQART TO LW_DATA_GENERAL-OBJECTTYPE,  "/Type of Tech Object
     ...
     IT_EQUI-INBDT TO LW_DATA_GENERAL-START_FROM. "/Start-up Date of the
    "  Technical Object
*    MOVE :
