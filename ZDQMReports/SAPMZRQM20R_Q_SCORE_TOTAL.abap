************************************************************************
* Program Name      : SAPMZRQM20R_Q_SCORE_TOTAL
...
REPORT  SAPMZRQM20R_Q_SCORE_TOTAL  NO STANDARD PAGE HEADING   .
...
SELECTION-SCREEN COMMENT 3(20) TEXT-T02  FOR FIELD P_QINDEX.
...
*-- Get GR/GI data from DB
  SELECT   A~BUDAT B~BWART B~MEINS E~WERKS
         ...
         FROM ( ( ( MKPF AS A        INNER JOIN MSEG AS B
           ...
           WHERE  A~MJAHR = P_YEAR
             ...
             AND B~BWART IN ('101', '102',            "/GR
                              '261', '901', '903',    "/GI
                              '262', '902', '904')
            GROUP BY A~BUDAT B~BWART B~MEINS E~WERKS.
