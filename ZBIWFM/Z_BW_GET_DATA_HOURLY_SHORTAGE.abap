FUNCTION z_bw_get_data_hourly_shortage.
*"----------------------------------------------------------------------
*"*"Local interface:
*"  IMPORTING
...
*"      E_T_DATA STRUCTURE  ZOXUD10134 OPTIONAL
*"  EXCEPTIONS
*"      NO_MORE_DATA
...
*      APPEND r_mtart.
      ...
      SELECT (s_s_if-t_fields) FROM ztmm_hour_short
...
*   named E_T_'Name of extract structure'.
    ...
    LOOP AT e_t_data INTO l_zoxud10134.
      l_tabix = sy-tabix.
      ...
      MODIFY e_t_data FROM l_zoxud10134 INDEX l_tabix.
