...
*get fsc
      SELECT matnr INTO CORRESPONDING FIELDS OF TABLE lt_fsc
      FROM mara
      WHERE MTART = 'FERT'.

      SORT lt_fsc BY matnr.
*      lt_fsc-matnr = '4B06AAEMFD76D 0075'.
      APPEND lt_fsc.
...
*        FROM mard
*        WHERE matnr = lt_fsc-matnr
*        GROUP by matnr.
*        ENDSELECT.
** delete if stock = 0 or no records
*        IF sy-subrc EQ 0.
*          IF $amt EQ 0.
*            DELETE lt_fsc INDEX $ix.
*          ENDIF.
*        ELSE.
*          DELETE lt_fsc INDEX $ix.
*        ENDIF.
      ...
      LOOP AT lt_fsc.
        ...
        CALL FUNCTION 'CS_BOM_EXPL_MAT_V2'
             EXPORTING
                  ...
                  mdmps =
                     'X' "Limited multi-lvl- explode phantom
                  mehrs =
