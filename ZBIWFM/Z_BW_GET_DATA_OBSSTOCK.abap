FUNCTION Z_BW_GET_DATA_OBSSTOCK.
*"----------------------------------------------------------------------
*"*"Local interface:
*"  IMPORTING
...
*"      E_T_DATA STRUCTURE  ZBWST_OBS OPTIONAL
*"  EXCEPTIONS
*"      NO_MORE_DATA
...
* Select ranges
  ...
  DATA: BEGIN OF lt_remark OCCURS 0,
          matnr   LIKE ZTMM_OBS_EIS-matnr,
          remark  LIKE ZTMM_OBS_EIS-remark,
          to_date LIKE ZTMM_OBS_EIS-to_date,
          to_time LIKE ZTMM_OBS_EIS-to_time,
        END OF lt_remark.
  ...
  RANGES: r_matnr FOR ZTMM_OBS_STOCK-matnr,
          r_mtart FOR ZTMM_OBS_STOCK-mtart,
          r_matkl FOR ZTMM_OBS_STOCK-matkl,
          r_dispo FOR ZTMM_OBS_STOCK-dispo,
          r_lifnr FOR ZTMM_OBS_STOCK-lifnr,
...
DATA : l_ZBWST_OBS LIKE ZBWST_OBS OCCURS 0 WITH HEADER LINE. "Obsolete s
...
*      APPEND r_mtart.
      ...
      SELECT (s_s_if-t_fields) FROM ZTMM_OBS_STOCK
...
*   named E_T_'Name of extract structure'.
    ...
    LOOP AT e_t_data INTO l_ZBWST_OBS.
      l_tabix = sy-tabix.

      READ TABLE lt_remark WITH KEY matnr = l_ZBWST_OBS-matnr
                             BINARY SEARCH.
      IF sy-subrc EQ 0.
        l_ZBWST_OBS-remark = lt_remark-remark.
      ENDIF.

      MODIFY e_t_data FROM l_ZBWST_OBS INDEX l_tabix.
