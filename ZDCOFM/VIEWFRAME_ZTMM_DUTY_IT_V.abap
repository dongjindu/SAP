*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZTMM_DUTY_IT_V
*   generation date: 05/11/2007 at 18:36:42 by user 103569
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZTMM_DUTY_IT_V      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZTMM_DUTY_IT_V'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZTMM_DUTY_IT_V_EXTRACT
TOTAL = ZTMM_DUTY_IT_V_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZTMM_DUTY_IT_V'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZTMM_DUTY_IT_V-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZTMM_DUTY_IT_V_EXTRACT
TOTAL = ZTMM_DUTY_IT_V_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZTMM_DUTY_IT_V-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZTMM_DUTY_IT_V'
...
TOTAL = ZTMM_DUTY_IT_V_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZTMM_DUTY_IT_V-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZTMM_DUTY_IT_V-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZTMM_DUTY_IT_V'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZTMM_DUTY_IT_V-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZTMM_DUTY_IT_V_EXTRACT
TOTAL = ZTMM_DUTY_IT_V_TOTAL
