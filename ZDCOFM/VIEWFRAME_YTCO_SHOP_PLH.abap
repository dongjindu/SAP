*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_YTCO_SHOP_PLH
*   generation date: 02/08/2008 at 13:12:02 by user HIS20018
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_YTCO_SHOP_PLH       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_YTCO_SHOP_PLH'
         EXPORTING
              FCODE          = READ
...
EXTRACT = YTCO_SHOP_PLH_EXTRACT
TOTAL = YTCO_SHOP_PLH_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_YTCO_SHOP_PLH'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_YTCO_SHOP_PLH-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YTCO_SHOP_PLH_EXTRACT
TOTAL = YTCO_SHOP_PLH_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_YTCO_SHOP_PLH-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_YTCO_SHOP_PLH'
...
TOTAL = YTCO_SHOP_PLH_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_YTCO_SHOP_PLH-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_YTCO_SHOP_PLH-UPD_FLAG NE SPACE.
