*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVCO_ML_REP_HIER
*   generation date: 12/19/2003 at 01:14:45 by user HJYOUN
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVCO_ML_REP_HIER    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVCO_ML_REP_HIER'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVCO_ML_REP_HIER_EXTRACT
TOTAL = ZVCO_ML_REP_HIER_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVCO_ML_REP_HIER'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVCO_ML_REP_HIER-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVCO_ML_REP_HIER_EXTRACT
TOTAL = ZVCO_ML_REP_HIER_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVCO_ML_REP_HIER-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVCO_ML_REP_HIER'
...
TOTAL = ZVCO_ML_REP_HIER_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVCO_ML_REP_HIER-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVCO_ML_REP_HIER-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVCO_ML_REP_HIER'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVCO_ML_REP_HIER-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVCO_ML_REP_HIER_EXTRACT
TOTAL = ZVCO_ML_REP_HIER_TOTAL
