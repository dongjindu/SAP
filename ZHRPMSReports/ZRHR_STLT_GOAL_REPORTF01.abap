...
FORM get_detail  USING    ps_documents TYPE hap_s_documents.
  ...
  IF lt_result[] IS NOT INITIAL.
    SORT lt_notes_0015 BY row_iid tabseqnr.
    SORT lt_notes_0016 BY row_iid tabseqnr.
    CLEAR lv_index.
    LOOP AT lt_result INTO ls_result.
      ADD 1 TO lv_index.

      READ TABLE lt_notes_0015 INTO ls_notes_0015 INDEX lv_index.
      IF sy-subrc = 0.
        ls_result-short = ls_notes_0015-tdline.
      ENDIF.

      READ TABLE lt_notes_0016 INTO ls_notes_0016 INDEX lv_index.
      IF sy-subrc = 0.
        ls_result-long = ls_notes_0016-tdline.
      ENDIF.
