...
* 10/03/2011 Valerian     UD1K953075   Adjust logic to follow Kronos
*                                      implementation
* 12/01/2011 Valerian     UQ1K900399   Adjust structure list_tab to
*                                      prevent ABAP Dump
...
data:   bukrs TYPE bukrs.                                   "UQ1K900399
data:   io TYPE c.                                          "UQ1K900399
...
*  IMPORT THE RESULT
  ...
  loop at list_table.
* BEGIN OF UD1K953075
    case list_table-lgart.
      when '0200'.
        list_table-lgart = 'REG1'.
      when '0901'.
        list_table-lgart = 'OT15'.
      when '0902'.
        list_table-lgart = 'OT20'.
      when '0110'.
        list_table-lgart = 'SP00'.
      when '0100'.
        list_table-lgart = 'SP00'.
      when '0101'.
        list_table-lgart = 'SP01'.
      when '0102'.
        list_table-lgart = 'SP02'.
    endcase.
    modify list_table index sy-tabix transporting lgart.
* END OF UD1K953075
...
*regular + OT
  loop at it_pay_ref where zgart ca '125X'.  "<> space.     "UD1K953075
* loop at it_pay_ref where zgart ca '12X'.  "<> space.      "UD1K953075
...
*         when '0310'.  it_data-hkont = p_vaca.
          ...
          when '1038' OR '1023' OR '1017'.
            it_data-hkont = p_vaca.
          when '1037' OR '1030' OR '1024' OR '1018' OR '1019' OR
               '1020' OR '1021' OR '1022' OR '1026'.
            it_data-hkont = p_leave.
          when others.
            continue.
