FUNCTION Z_FMM_GET_CHARACT_MES.
*"----------------------------------------------------------------------
*"*"Local interface:
*"  IMPORTING
*"     REFERENCE(I_MATNR) LIKE  MARA-MATNR
*"  EXPORTING
*"     REFERENCE(ES_ZSMM_CLASS) LIKE  ZSMM_CLASS_MES STRUCTURE
*"        ZSMM_CLASS_MES
*"  EXCEPTIONS
*"      DATA_NOT_FOUND
*"----------------------------------------------------------------------
*& Date         Developer       Request        Description
*& 08/16/06     Manju           UD1K921769     Initial coding
*&                                          (Copy of Z_FMM_GET_CHARACT )
*&----------------------------------------------------------------------
...
*           lw_coat_front  = lt_allocvalueschar-value_char.
            es_zsmm_class-ZFFINISH  = lt_allocvalueschar-value_char.
          WHEN 'ZBACK_FINISHING_THICKNESS'.  "back finishing thick
*           lw_coat_back   = lt_allocvalueschar-value_char.
            es_zsmm_class-ZBFINISH = lt_allocvalueschar-value_char.
