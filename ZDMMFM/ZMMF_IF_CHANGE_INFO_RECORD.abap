FUNCTION zmmf_if_change_info_record.
*"----------------------------------------------------------------------
*"*"Local interface:
*"  IMPORTING
...
* 06/15/06     Manju         UD1K921064     Program fix - To handle *
*                                           situation when condition is
*                                            not maintained.
*-----------------------------------------------------------------------
*"----------------------------------------------------------------------
  ...
  MOVE: 'R'           TO v_flag. " change info record flag in log table
