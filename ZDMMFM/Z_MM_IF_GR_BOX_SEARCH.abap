FUNCTION Z_MM_IF_GR_BOX_SEARCH .
*"----------------------------------------------------------------------
*"*"Local interface:
*"  IMPORTING
...
*.. External Identification of Delivery Note?? ???? ???? ??
  IF G_LIFEX IS INITIAL.
    ...
    PERFORM ERROR_LOG USING 'MMIF_PDA_03' 'PDA' 'US' 'I' ' ' 'S' G_TYPE
                            E_MSG ''  ''  ''.
    EXIT.
  ENDIF.
...
*.. No Delivery Note
  ...
  PERFORM ERROR_LOG USING 'MMIF_PDA_03' 'PDA' 'US' 'I' ' ' 'S'
                          G_TYPE  G_MSG
