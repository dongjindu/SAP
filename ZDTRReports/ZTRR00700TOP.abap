...
DATA : PREV_BEGIN   LIKE  FDSR OCCURS 0 WITH HEADER LINE,
       PREV_END     LIKE  FDSR OCCURS 0 WITH HEADER LINE,
       PREV_PLAN    LIKE  FDSR OCCURS 0 WITH HEADER LINE,
       PREV_ACT     LIKE  FDSR OCCURS 0 WITH HEADER LINE,

       PLAN         LIKE  FDSR OCCURS 0 WITH HEADER LINE,
       BEGINNING    LIKE  FDSR OCCURS 0 WITH HEADER LINE,
       ENDING       LIKE  FDSR OCCURS 0 WITH HEADER LINE,
       PREV_DATE    LIKE  SY-DATUM OCCURS 0 WITH HEADER LINE,
...
PARAMETERS     : P_HIER  LIKE TKCHH-ID2 DEFAULT 'H01'
                 ...
                 P_SEQNO LIKE ZTTR0008-SEQNO  OBLIGATORY.
...
AT SELECTION-SCREEN ON VALUE-REQUEST FOR P_SEQNO.
  ...
  clear: GT_SEQ, GT_SEQ[], L_TITLE.

  GT_SCRFIELD-FIELDNAME = 'P_DATUM'.
  IAPPEND GT_SCRFIELD.
  ...
  READ TABLE GT_SCRFIELD WITH KEY FIELDNAME = 'P_DATUM'.
  ...
  WRITE L_PDAT1 TO L_TITLE.
  CONCATENATE 'Plan Version :' L_TITLE INTO L_TITLE.
