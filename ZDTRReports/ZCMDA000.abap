report ZCMDA000.
tables: fdd1, fdsb, fdsr, t036v, tzpa.
...
* Ermittlung der Produktarten, die zu Darlehen gehören
r_gsart-sign   = 'I'.
r_gsart-option = 'EQ'.
select * from tzpa
       where rantyp = '1'.             "1-Darlehen
...
delete from fdd1 where bukrs = space or bukrs <> space.
commit work.
submit rffdda00
       with p_test = space.
