...
*----------------------------------------------------------------------*
* Modified by Haseeb on 02-10-2005 as ZPF2 is also a Invoice.
* Change initiated by Lance.  Transport ' UD1K919276'
...
* Modified by Haseeb on 02-10-2005 as ZPF2 is also a Invoice.
* Change initiated by Lance.  Transport ' UD1K919276'
  IF VBRK-FKART = 'ZVF2' or VBRK-FKART = 'ZPF2'.
    W_SIGN = ''.
    IT_INV_H-Z112 = ''.
  ELSE. "ZVRE
    W_SIGN = '-'.
...
FORM CALL_SM USING RC.
  CALL FUNCTION 'SSF_FUNCTION_MODULE_NAME'
    EXPORTING
      FORMNAME           = 'ZSSD05_HMA_COMMERCIAL_INVOICE'
      IMPORTING
