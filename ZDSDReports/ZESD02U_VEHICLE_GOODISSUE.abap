...
** Inserted by Furong on 07/20/2010
  LOOP AT it_bfst.
    CONCATENATE it_bfst-model it_bfst-body_ser INTO l_bodyno.
    ...
    l_date = w_n_8 = l_atflv.

    IF l_date > c_cg_date.

** Changed by Furong on 06/09/11
...
** End on 06/09/11
  ...
  ENDLOOP.
** End of insertion on 07/20/2010
...
* by ig.moon 4/5/2012 {
      ztsd_veh_log-erdat = sy-datum.
      ztsd_veh_log-erzet = sy-uzeit.
      ztsd_veh_log-ernam = sy-uname.
* }
      MODIFY ztsd_veh_log.
    ELSE.
