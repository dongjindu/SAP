...
FORM HEADER_DATA_CAL.
  ...
  PERFORM FILL_DATA_CAL USING  7   1 IT_LIST-VBELN.
  PERFORM FILL_DATA_CAL USING  8   1 IT_LIST-FKDAT.
  PERFORM FILL_DATA_CAL USING  9   1 IT_LIST-NETWR.
  PERFORM FILL_DATA_CAL USING  10  1 'testing'.
