*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZTPP_KSBOHMM_V
*   generation date: 05/03/2007 at 14:06:40 by user 101457
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZTPP_KSBOHMM_V      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZTPP_KSBOHMM_V'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZTPP_KSBOHMM_V_EXTRACT
TOTAL = ZTPP_KSBOHMM_V_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZTPP_KSBOHMM_V'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZTPP_KSBOHMM_V-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZTPP_KSBOHMM_V_EXTRACT
TOTAL = ZTPP_KSBOHMM_V_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZTPP_KSBOHMM_V-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZTPP_KSBOHMM_V'
...
TOTAL = ZTPP_KSBOHMM_V_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZTPP_KSBOHMM_V-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZTPP_KSBOHMM_V-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZTPP_KSBOHMM_V'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZTPP_KSBOHMM_V-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZTPP_KSBOHMM_V_EXTRACT
TOTAL = ZTPP_KSBOHMM_V_TOTAL
