...
*"----------------------------------------------------------------------
 ...
 SELECT *
     INTO CORRESPONDING FIELDS OF TABLE T_GCCELOG
    FROM ZTPP_GCC_ELOG
     WHERE ELOG_FLAG IS NULL OR ELOG_FLAG = ' '
     ORDER BY ELOG_DATE ELOG_KIND ELOG_LOC ELOG_SEQ.
...
*     INTO CORRESPONDING FIELDS OF TABLE T_GCCELOG
*    FROM ZTPP_GCC_ELOG
*     WHERE ELOG_DATE = L_DATE
*      AND ( ELOG_FLAG IS NULL OR ELOG_FLAG = ' ' )
*     ORDER BY ELOG_DATE ELOG_KIND ELOG_LOC ELOG_SEQ.
*  ELSEIF NOT I_FDATE IS INITIAL AND I_TDATE IS INITIAL.
*    SELECT *
*     INTO CORRESPONDING FIELDS OF TABLE T_GCCELOG
*    FROM ZTPP_GCC_ELOG
*     WHERE ELOG_DATE = I_FDATE
*     AND ( ELOG_FLAG IS NULL OR ELOG_FLAG = ' ' )
*     ORDER BY ELOG_DATE ELOG_KIND ELOG_LOC ELOG_SEQ.
*  ELSE.
*    SELECT *
*     INTO CORRESPONDING FIELDS OF TABLE T_GCCELOG
*    FROM ZTPP_GCC_ELOG
*     WHERE ( ELOG_DATE BETWEEN I_FDATE AND I_TDATE )
*     AND ( ELOG_FLAG IS NULL OR ELOG_FLAG = ' ' )
*     ORDER BY ELOG_DATE ELOG_KIND ELOG_LOC ELOG_SEQ.
*  ENDIF.
*
...
*        V_SEQ LIKE ZTPP_GCC_ELOG-ELOG_SEQ,
