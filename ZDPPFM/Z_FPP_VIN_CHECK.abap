FUNCTION Z_FPP_VIN_CHECK.
*"----------------------------------------------------------------------
*"*"Local interface:
*"  IMPORTING
*"     REFERENCE(W_ORDER) LIKE  ZSPPVR-P_WORK_ORDER
*"     REFERENCE(MODE) TYPE  ZSPPVR-P_MODEL
*"     REFERENCE(BODY_NO) LIKE  ZSPPVR-P_BODY_SERIAL
*"  EXPORTING
*"     REFERENCE(P_LASTID) LIKE  ZSPPVR-P_VIN
*"  EXCEPTIONS
*"      NOT_FOUND
*"----------------------------------------------------------------------
  DATA: L_STRING(1),
