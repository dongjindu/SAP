...
*Program name        : Include ZTPP_WOSUM2_BK_T
...
TABLES: ZTPP_WOSUM2_BK .       " Object Table
...
DATA: T_ITAB  LIKE ZTPP_WOSUM2_BK OCCURS 0 WITH HEADER LINE,
      BUFFER  TYPE ARC_BUFFER,
      S_ITAB  LIKE ZTPP_WOSUM2_BK .
DATA  ARC_STRUCT    LIKE ARC_BUFFER-RNAME VALUE
'ZTPP_WOSUM2_BK' . "Layout
DATA  ARC_TABLE     LIKE ARC_BUFFER-RNAME VALUE
'ZTPP_WOSUM2_BK' . "Table
