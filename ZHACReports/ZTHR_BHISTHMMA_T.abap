...
*Program name        : Include ZTHR_BHISTHMMA_T
...
TABLES: ZTHR_BHISTHMMA .       " Object Table
...
DATA: T_ITAB  LIKE ZTHR_BHISTHMMA OCCURS 0 WITH HEADER LINE,
      BUFFER  TYPE ARC_BUFFER,
      S_ITAB  LIKE ZTHR_BHISTHMMA .
DATA  ARC_STRUCT    LIKE ARC_BUFFER-RNAME VALUE
'ZTHR_BHISTHMMA' . "Layout
DATA  ARC_TABLE     LIKE ARC_BUFFER-RNAME VALUE
'ZTHR_BHISTHMMA' . "Table
