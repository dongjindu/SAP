...
*&---------------------------------------------------------------------*
FORM DATA_PROCESSING.
  DATA LT_ZACTMCTB LIKE ZACRS001 OCCURS 0 WITH HEADER LINE.

  PERFORM SELECT_ZACTMCTB
                      TABLES LT_ZACTMCTB.
...
*&---------------------------------------------------------------------*
*&      Form  SELECT_ZACTMCTB
*&---------------------------------------------------------------------*
FORM SELECT_ZACTMCTB
                  TABLES PT_ZACTMCTB STRUCTURE ZACRS001.
  ...
  SELECT
    ...
    INTO CORRESPONDING FIELDS OF TABLE PT_ZACTMCTB.
***
***  SELECT
***    PROGNAME
***    TABNAME
...
FORM MOVE_DATA_TO_LIST
  ...
  LOOP AT PT_ZACTMCTB.
    MOVE-CORRESPONDING PT_ZACTMCTB TO GT_LIST.
    APPEND GT_LIST.
    CLEAR GT_LIST.
  ENDLOOP.
