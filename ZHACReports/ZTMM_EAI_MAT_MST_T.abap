...
*Program name        : Include ZTMM_EAI_MAT_MST_T
...
TABLES: ZTMM_EAI_MAT_MST .       " Object Table
...
DATA: T_ITAB  LIKE ZTMM_EAI_MAT_MST OCCURS 0 WITH HEADER LINE,
      BUFFER  TYPE ARC_BUFFER,
      S_ITAB  LIKE ZTMM_EAI_MAT_MST .
DATA  ARC_STRUCT    LIKE ARC_BUFFER-RNAME VALUE
'ZTMM_EAI_MAT_MST' . "Layout
DATA  ARC_TABLE     LIKE ARC_BUFFER-RNAME VALUE
'ZTMM_EAI_MAT_MST' . "Table
