...
*Program name        : Include ZTMM_MOD_PRI_BK_T
...
TABLES: ZTMM_MOD_PRI_BK .       " Object Table
...
DATA: T_ITAB  LIKE ZTMM_MOD_PRI_BK OCCURS 0 WITH HEADER LINE,
      BUFFER  TYPE ARC_BUFFER,
      S_ITAB  LIKE ZTMM_MOD_PRI_BK .
DATA  ARC_STRUCT    LIKE ARC_BUFFER-RNAME VALUE
'ZTMM_MOD_PRI_BK' . "Layout
DATA  ARC_TABLE     LIKE ARC_BUFFER-RNAME VALUE
'ZTMM_MOD_PRI_BK' . "Table
