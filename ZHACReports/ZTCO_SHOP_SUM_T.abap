...
*Program name        : Include ZTCO_SHOP_SUM_T
...
TABLES: ZTCO_SHOP_SUM .       " Object Table
...
DATA: T_ITAB  LIKE ZTCO_SHOP_SUM OCCURS 0 WITH HEADER LINE,
      BUFFER  TYPE ARC_BUFFER,
      S_ITAB  LIKE ZTCO_SHOP_SUM .
DATA  ARC_STRUCT    LIKE ARC_BUFFER-RNAME VALUE
'ZTCO_SHOP_SUM' . "Layout
