...
*Program name        : Archiving : ZMMT0102 (Write)
...
*SELECT-OPTIONS S_CENTY FOR ZMMT0102-CENTY.
*SELECT-OPTIONS S_IFKEY FOR ZMMT0102-IFKEY.
*SELECT-OPTIONS S_IFSEQ FOR ZMMT0102-IFSEQ.
SELECT-OPTIONS S_ETDAT FOR ZMMT0102-ETDAT.
