...
*Program name        : Include ZTPP_RESB_B06_T
...
TABLES: ZTPP_RESB_B06 .       " Object Table
...
DATA: T_ITAB  LIKE ZTPP_RESB_B06 OCCURS 0 WITH HEADER LINE,
      BUFFER  TYPE ARC_BUFFER,
      S_ITAB  LIKE ZTPP_RESB_B06 .
DATA  ARC_STRUCT    LIKE ARC_BUFFER-RNAME VALUE
'ZTPP_RESB_B06' . "Layout
