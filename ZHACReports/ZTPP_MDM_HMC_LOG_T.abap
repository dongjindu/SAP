...
*Program name        : Include ZTPP_MDM_HMC_LOG_T
...
TABLES: ZTPP_MDM_HMC_LOG .       " Object Table
...
DATA: T_ITAB  LIKE ZTPP_MDM_HMC_LOG OCCURS 0 WITH HEADER LINE,
      BUFFER  TYPE ARC_BUFFER,
      S_ITAB  LIKE ZTPP_MDM_HMC_LOG .
DATA  ARC_STRUCT    LIKE ARC_BUFFER-RNAME VALUE
'ZTPP_MDM_HMC_LOG' . "Layout
DATA  ARC_TABLE     LIKE ARC_BUFFER-RNAME VALUE
'ZTPP_MDM_HMC_LOG' . "Table
