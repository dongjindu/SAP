...
*Program name        : Include ZTMM_EAI_DEMAND_T
...
TABLES: ZTMM_EAI_DEMAND .       " Object Table
...
DATA: T_ITAB  LIKE ZTMM_EAI_DEMAND OCCURS 0 WITH HEADER LINE,
      BUFFER  TYPE ARC_BUFFER,
      S_ITAB  LIKE ZTMM_EAI_DEMAND .
DATA  ARC_STRUCT    LIKE ARC_BUFFER-RNAME VALUE
'ZTMM_EAI_DEMAND' . "Layout
DATA  ARC_TABLE     LIKE ARC_BUFFER-RNAME VALUE
'ZTMM_EAI_DEMAND' . "Table
