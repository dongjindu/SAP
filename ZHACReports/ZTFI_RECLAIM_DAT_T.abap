...
*Program name        : Include ZTFI_RECLAIM_DAT_T
...
TABLES: ZTFI_RECLAIM_DAT .       " Object Table
...
DATA: T_ITAB  LIKE ZTFI_RECLAIM_DAT OCCURS 0 WITH HEADER LINE,
      BUFFER  TYPE ARC_BUFFER,
      S_ITAB  LIKE ZTFI_RECLAIM_DAT .
DATA  ARC_STRUCT    LIKE ARC_BUFFER-RNAME VALUE
'ZTFI_RECLAIM_DAT' . "Layout
DATA  ARC_TABLE     LIKE ARC_BUFFER-RNAME VALUE
'ZTFI_RECLAIM_DAT' . "Table
