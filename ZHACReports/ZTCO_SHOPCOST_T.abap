...
*Program name        : Include ZTCO_SHOPCOST_T
...
TABLES: ZTCO_SHOPCOST .       " Object Table
...
DATA: T_ITAB  LIKE ZTCO_SHOPCOST OCCURS 0 WITH HEADER LINE,
      BUFFER  TYPE ARC_BUFFER,
      S_ITAB  LIKE ZTCO_SHOPCOST .
DATA  ARC_STRUCT    LIKE ARC_BUFFER-RNAME VALUE
'ZTCO_SHOPCOST' . "Layout
