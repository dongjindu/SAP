...
*Program name        : Include ZTFI_RECLAIM_LOG_T
...
TABLES: ZTFI_RECLAIM_LOG .       " Object Table
...
DATA: T_ITAB  LIKE ZTFI_RECLAIM_LOG OCCURS 0 WITH HEADER LINE,
      BUFFER  TYPE ARC_BUFFER,
      S_ITAB  LIKE ZTFI_RECLAIM_LOG .
DATA  ARC_STRUCT    LIKE ARC_BUFFER-RNAME VALUE
'ZTFI_RECLAIM_LOG' . "Layout
DATA  ARC_TABLE     LIKE ARC_BUFFER-RNAME VALUE
'ZTFI_RECLAIM_LOG' . "Table
