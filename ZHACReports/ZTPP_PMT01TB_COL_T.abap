...
*Program name        : Include ZTPP_PMT01TB_COL_T
...
TABLES: ZTPP_PMT01TB_COL .       " Object Table
...
DATA: T_ITAB  LIKE ZTPP_PMT01TB_COL OCCURS 0 WITH HEADER LINE,
      BUFFER  TYPE ARC_BUFFER,
      S_ITAB  LIKE ZTPP_PMT01TB_COL .
DATA  ARC_STRUCT    LIKE ARC_BUFFER-RNAME VALUE
'ZTPP_PMT01TB_COL' . "Layout
DATA  ARC_TABLE     LIKE ARC_BUFFER-RNAME VALUE
'ZTPP_PMT01TB_COL' . "Table
