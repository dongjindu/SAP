...
*"     VALUE(BKTXT_003) LIKE  BDCDATA-FVAL DEFAULT 'Q3 notif'
...
*"     VALUE(XFULL_010) LIKE  BDCDATA-FVAL DEFAULT ''
*"     VALUE(WVERS1_011) LIKE  BDCDATA-FVAL DEFAULT 'X'
*"     VALUE(XSELK_08_012) LIKE  BDCDATA-FVAL DEFAULT 'X'
*"     VALUE(ERFMG_08_013) LIKE  BDCDATA-FVAL DEFAULT '1'
...
*{   REPLACE        UP1K900137                                        2
*\                              BLDAT_001.
                               Z_ZDATE.
*}   REPLACE
perform bdc_field       using 'MKPF-BUDAT'
*{   REPLACE        UP1K900137                                        3
*\                              BUDAT_002.
                               Z_ZDATE.
...
perform bdc_dynpro      using 'SAPMM07M' '0221'.
perform bdc_field       using 'BDC_CURSOR'
*{   REPLACE        UP1K900137                                       11
*\                              'MSEG-ERFMG(08)'.
                              'MSEG-ERFMG(08)'.
*}   REPLACE
perform bdc_field       using 'BDC_OKCODE'
                              '=BU'.
*{   REPLACE        UP1K900137                                       14
*\perform bdc_field       using 'RM07M-XSELK(08)'
perform bdc_field       using 'RM07M-XSELK(08)'
*}   REPLACE
*{   REPLACE        UP1K900137                                       12
*\                              XSELK_08_012.
                              XSELK_08_012.
*}   REPLACE
*{   REPLACE        UP1K900137                                       13
*\perform bdc_field       using 'MSEG-ERFMG(08)'
perform bdc_field       using 'MSEG-ERFMG(08)'
*}   REPLACE
