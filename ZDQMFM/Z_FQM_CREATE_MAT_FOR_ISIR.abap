FUNCTION Z_FQM_CREATE_MAT_FOR_ISIR.
*"----------------------------------------------------------------------
*"*"Local interface:
*"  IMPORTING
...
*"     VALUE(I_BDCMODE) TYPE  TB_BDCMODE DEFAULT 'A'
*"  EXPORTING
...
*  DATA   END OF IT_MSG.
  ...
  PERFORM DYNPRO  USING:
    'X'   'SAPLMGMM'          '0060',
    ' '   'BDC_OKCODE'        '=AUSW',  "/Select view '/00',
    ' '   'RMMG1-MATNR'       I_MATNR,
    ' '   'RMMG1-MBRSH'       'A',     "/Industry sector : Automative
    ' '   'RMMG1-MTART'       'QCIS'.  "/Developing material

  PERFORM DYNPRO  USING:
    'X'   'SAPLMGMM'                  '0070',
    ' '   'BDC_OKCODE'                '=ENTR',
    ' '   'MSICHTAUSW-KZSEL(01)'       C_MARK, "/Basic view 1
    ' '   'MSICHTAUSW-KZSEL(03)'       C_MARK. "/QM View

  PERFORM DYNPRO  USING:
    'X'   'SAPLMGMM'         '0080',
    ' '   'BDC_OKCODE'       '=ENTR',
    ' '   'RMMG1-WERKS'       I_WERKS.      "/Plant
