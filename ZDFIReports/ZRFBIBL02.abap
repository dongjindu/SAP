...
FORM FILL_FTPOST_WITH_BBKPF_DATA.
  ...
  IF BBKPF-AUGTX(1)                    NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'RF05A-AUGTX                      '.
    FTPOST-FVAL = BBKPF-AUGTX                      .
    APPEND FTPOST.
  ENDIF.
  IF BBKPF-XPRFG(1)                    NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BKPF-XPRFG                       '.
    FTPOST-FVAL = BBKPF-XPRFG                      .
    APPEND FTPOST.
  ENDIF.
  IF BBKPF-XBWAE(1)                    NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'VBKPF-XBWAE                      '.
    FTPOST-FVAL = BBKPF-XBWAE                      .
    APPEND FTPOST.
  ENDIF.
  IF BBKPF-LDGRP(1)                    NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BKPF-LDGRP                       '.
    FTPOST-FVAL = BBKPF-LDGRP                      .
    APPEND FTPOST.
  ENDIF.
...
FORM FILL_FTPOST_WITH_BBSEG_DATA USING COUNT.
  ...
  IF BBSEG-DUMMYX(1)                   NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-DUMMYX                      '.
    FTPOST-FVAL = BBSEG-DUMMYX                     .
    APPEND FTPOST.
  ENDIF.
  ...
  IF BBSEG-XREF2(1)                    NE NODATA.
    ...
    APPEND FTPOST.
  ENDIF.
*  IF BBSEG-ZZCOUNTRY(1)                NE NODATA.
*    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
*    IF XTBSL-KOART = 'S' OR XTBSL-KOART = 'A'.
*      FTPOST-FNAM = 'COBL-ZZCOUNTRY                   '.
*    ELSE.
*      FTPOST-FNAM = 'BSEG-ZZCOUNTRY                   '.
*    ENDIF.
*    FTPOST-FVAL = BBSEG-ZZCOUNTRY                  .
*    APPEND FTPOST.
*  ENDIF.
  ...
  IF BBSEG-WSTKZ(1)                    NE NODATA.
    ...
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_ARTNR(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_ARTNR                   '.
    FTPOST-FVAL = BBSEG-RKE_ARTNR                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_BONUS(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_BONUS                   '.
    FTPOST-FVAL = BBSEG-RKE_BONUS                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_BRSCH(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_BRSCH                   '.
    FTPOST-FVAL = BBSEG-RKE_BRSCH                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_BUKRS(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_BUKRS                   '.
    FTPOST-FVAL = BBSEG-RKE_BUKRS                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_BZIRK(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_BZIRK                   '.
    FTPOST-FVAL = BBSEG-RKE_BZIRK                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_EFORM(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_EFORM                   '.
    FTPOST-FVAL = BBSEG-RKE_EFORM                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_FKART(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_FKART                   '.
    FTPOST-FVAL = BBSEG-RKE_FKART                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_GEBIE(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_GEBIE                   '.
    FTPOST-FVAL = BBSEG-RKE_GEBIE                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_GSBER(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_GSBER                   '.
    FTPOST-FVAL = BBSEG-RKE_GSBER                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_KAUFN(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_KAUFN                   '.
    FTPOST-FVAL = BBSEG-RKE_KAUFN                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_KDGRP(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_KDGRP                   '.
    FTPOST-FVAL = BBSEG-RKE_KDGRP                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_KDPOS(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_KDPOS                   '.
    FTPOST-FVAL = BBSEG-RKE_KDPOS                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_KNDNR(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_KNDNR                   '.
    FTPOST-FVAL = BBSEG-RKE_KNDNR                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_KOKRS(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_KOKRS                   '.
    FTPOST-FVAL = BBSEG-RKE_KOKRS                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_KSTRG(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_KSTRG                   '.
    FTPOST-FVAL = BBSEG-RKE_KSTRG                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_LAND1(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_LAND1                   '.
    FTPOST-FVAL = BBSEG-RKE_LAND1                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_MAABC(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_MAABC                   '.
    FTPOST-FVAL = BBSEG-RKE_MAABC                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_MATKL(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_MATKL                   '.
    FTPOST-FVAL = BBSEG-RKE_MATKL                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_PRCTR(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_PRCTR                   '.
    FTPOST-FVAL = BBSEG-RKE_PRCTR                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_PSPNR(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_PSPNR                   '.
    FTPOST-FVAL = BBSEG-RKE_PSPNR                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_RKAUFNR(1)              NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_RKAUFNR                 '.
    FTPOST-FVAL = BBSEG-RKE_RKAUFNR                .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_SPART(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_SPART                   '.
    FTPOST-FVAL = BBSEG-RKE_SPART                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_VKBUR(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_VKBUR                   '.
    FTPOST-FVAL = BBSEG-RKE_VKBUR                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_VKGRP(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_VKGRP                   '.
    FTPOST-FVAL = BBSEG-RKE_VKGRP                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_VKORG(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_VKORG                   '.
    FTPOST-FVAL = BBSEG-RKE_VKORG                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_VTWEG(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_VTWEG                   '.
    FTPOST-FVAL = BBSEG-RKE_VTWEG                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_WERKS(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_WERKS                   '.
    FTPOST-FVAL = BBSEG-RKE_WERKS                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_KMBRND(1)               NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_KMBRND                  '.
    FTPOST-FVAL = BBSEG-RKE_KMBRND                 .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_KMCATG(1)               NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_KMCATG                  '.
    FTPOST-FVAL = BBSEG-RKE_KMCATG                 .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_KMHI01(1)               NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_KMHI01                  '.
    FTPOST-FVAL = BBSEG-RKE_KMHI01                 .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_KMHI02(1)               NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_KMHI02                  '.
    FTPOST-FVAL = BBSEG-RKE_KMHI02                 .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_KMHI03(1)               NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_KMHI03                  '.
    FTPOST-FVAL = BBSEG-RKE_KMHI03                 .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_KMKDGR(1)               NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_KMKDGR                  '.
    FTPOST-FVAL = BBSEG-RKE_KMKDGR                 .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_KMLAND(1)               NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_KMLAND                  '.
    FTPOST-FVAL = BBSEG-RKE_KMLAND                 .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_KMMAKL(1)               NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_KMMAKL                  '.
    FTPOST-FVAL = BBSEG-RKE_KMMAKL                 .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_KMNIEL(1)               NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_KMNIEL                  '.
    FTPOST-FVAL = BBSEG-RKE_KMNIEL                 .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_KMSTGE(1)               NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_KMSTGE                  '.
    FTPOST-FVAL = BBSEG-RKE_KMSTGE                 .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_KMVKBU(1)               NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_KMVKBU                  '.
    FTPOST-FVAL = BBSEG-RKE_KMVKBU                 .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_KMVKGR(1)               NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_KMVKGR                  '.
    FTPOST-FVAL = BBSEG-RKE_KMVKGR                 .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_KMVTNR(1)               NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_KMVTNR                  '.
    FTPOST-FVAL = BBSEG-RKE_KMVTNR                 .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_PPRCTR(1)               NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_PPRCTR                  '.
    FTPOST-FVAL = BBSEG-RKE_PPRCTR                 .
    APPEND FTPOST.
  ENDIF.
*  IF BBSEG-RKE_PARTNR(1)               NE NODATA.
*    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
*    FTPOST-FNAM = 'BSEG-RKE_PARTNR                  '.
*    FTPOST-FVAL = BBSEG-RKE_PARTNR                 .
*    APPEND FTPOST.
*  ENDIF.
  ...
  IF BBSEG-IDXSP(1)                    NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-IDXSP                       '.
    FTPOST-FVAL = BBSEG-IDXSP                      .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-ANRED(1)                    NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEC-ANRED                       '.
    FTPOST-FVAL = BBSEG-ANRED                      .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RECNNR(1)                   NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'LFVI9-RECNNR                     '.
    FTPOST-FVAL = BBSEG-RECNNR                     .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-E_MIVE(1)                   NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'LFVI9-E_MIVE                     '.
    FTPOST-FVAL = BBSEG-E_MIVE                     .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-BKREF(1)                    NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEC-BKREF                       '.
    FTPOST-FVAL = BBSEG-BKREF                      .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-DTAMS(1)                    NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEC-DTAMS                       '.
    FTPOST-FVAL = BBSEG-DTAMS                      .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-CESSION_KZ(1)               NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-CESSION_KZ                  '.
    FTPOST-FVAL = BBSEG-CESSION_KZ                 .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-GRANT_NBR(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    IF XTBSL-KOART = 'S' OR XTBSL-KOART = 'A'.
      FTPOST-FNAM = 'COBL-GRANT_NBR                   '.
    ELSE.
      FTPOST-FNAM = 'BSEG-GRANT_NBR                   '.
    ENDIF.
    FTPOST-FVAL = BBSEG-GRANT_NBR                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-FKBER_LONG(1)               NE NODATA.
    ...
    ELSE.
      FTPOST-FNAM = 'BSEG-FKBER_LONG                  '.
    ENDIF.
    FTPOST-FVAL = BBSEG-FKBER_LONG                 .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-ERLKZ(1)                    NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    IF XTBSL-KOART = 'S' OR XTBSL-KOART = 'A'.
      FTPOST-FNAM = 'COBL-ERLKZ                       '.
    ELSE.
      FTPOST-FNAM = 'BSEG-ERLKZ                       '.
    ENDIF.
    FTPOST-FVAL = BBSEG-ERLKZ                      .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-IBAN(1)                     NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'TIBAN-IBAN                       '.
    FTPOST-FVAL = BBSEG-IBAN                       .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-VALID_FROM(1)               NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'TIBAN-VALID_FROM                 '.
    FTPOST-FVAL = BBSEG-VALID_FROM                 .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-SEGMENT(1)                  NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    IF XTBSL-KOART = 'S' OR XTBSL-KOART = 'A'.
      FTPOST-FNAM = 'COBL-SEGMENT                     '.
    ELSE.
      FTPOST-FNAM = 'BSEG-SEGMENT                     '.
    ENDIF.
    FTPOST-FVAL = BBSEG-SEGMENT                    .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-PSEGMENT(1)                 NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    IF XTBSL-KOART = 'S' OR XTBSL-KOART = 'A'.
      FTPOST-FNAM = 'COBL-PSEGMENT                    '.
    ELSE.
      FTPOST-FNAM = 'BSEG-PSEGMENT                    '.
    ENDIF.
    FTPOST-FVAL = BBSEG-PSEGMENT                   .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-HKTID(1)                    NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-HKTID                       '.
    FTPOST-FVAL = BBSEG-HKTID                      .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-XSIWE(1)                    NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSED-XSIWE                       '.
    FTPOST-FVAL = BBSEG-XSIWE                      .
    APPEND FTPOST.
  ENDIF.
...
FORM FILL_FTTAX_WITH_BBTAX_DATA.
  ...
  ENDIF.
  IF BBTAX-TXKRS(1)                    NE NODATA.
    FTTAX-TXKRS = BBTAX-TXKRS .
  ENDIF.
