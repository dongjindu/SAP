...
DATA :  p_data_cnt       TYPE  i,
        ...
        w_total_amt_xx   LIKE  ztmm_duty_it-duty_amt,      "amt
        w_total_amt_cn   LIKE  ztmm_duty_it-duty_amt,      "amt
...
*b2 Vendor
SELECTION-SCREEN BEGIN OF LINE.
SELECTION-SCREEN COMMENT 1(15)   text-b21 FOR FIELD p_ven2.
PARAMETERS :  p_ven2             like ekko-lifnr OBLIGATORY.
SELECTION-SCREEN END OF LINE.
*b3 Vendor Text	
SELECTION-SCREEN BEGIN OF LINE.
...
*SELECTION-SCREEN COMMENT 79(05)  text-b46 FOR FIELD p_text12.
*PARAMETERS :  p_text12    TYPE   ztmm_duty_hd-fentp    OBLIGATORY  DEFAULT '06'.
SELECTION-SCREEN END OF LINE.
SELECTION-SCREEN SKIP 1.
...
*SELECTION-SCREEN COMMENT 79(05)  text-b46 FOR FIELD p_text32.
*PARAMETERS :  p_text32    TYPE   ztmm_duty_hd-fentp.
...
PARAMETERS :  p_bdcmod    TYPE ctu_mode DEFAULT 'A'..
