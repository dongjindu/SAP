...
FORM FILL_FTPOST_WITH_BBSEG_DATA USING COUNT.
  ...
  IF BBSEG-TCNO(1)                     NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'REIT_TAX_CORRECTION_S-TCNO          '.
    FTPOST-FVAL = BBSEG-TCNO                       .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-DATEOFSERVICE(1)            NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'REIT_TAX_CORRECTION_S-DATEOFSERVICE '.
    FTPOST-FVAL = BBSEG-DATEOFSERVICE              .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-NOTAXCORR(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'REIT_TAX_CORRECTION_S-NOTAXCORR     '.
    FTPOST-FVAL = BBSEG-NOTAXCORR                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-DIFFOPTRATE(1)              NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'REIT_TAX_CORRECTION_S-DIFFOPTRATE   '.
    FTPOST-FVAL = BBSEG-DIFFOPTRATE                .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-HASDIFFOPTRATE(1)           NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'REIT_TAX_CORRECTION_S-HASDIFFOPTRATE'.
    FTPOST-FVAL = BBSEG-HASDIFFOPTRATE             .
    APPEND FTPOST.
  ENDIF.
* BEGIN OF UD1K954413
*  IF BBSEG-AVGACT_G(1)                 NE NODATA.
*    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
*    FTPOST-FNAM = 'BSEG-AVGACT_G                       '.
*    FTPOST-FVAL = BBSEG-AVGACT_G                   .
*    APPEND FTPOST.
*  ENDIF.
*  IF BBSEG-AVGACT_L(1)                 NE NODATA.
*    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
*    FTPOST-FNAM = 'BSEG-AVGACT_L                       '.
*    FTPOST-FVAL = BBSEG-AVGACT_L                   .
*    APPEND FTPOST.
*  ENDIF.
*  IF BBSEG-AVGACT_T(1)                 NE NODATA.
*    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
*    FTPOST-FNAM = 'BSEG-AVGACT_T                       '.
*    FTPOST-FVAL = BBSEG-AVGACT_T                   .
*    APPEND FTPOST.
*  ENDIF.
*  IF BBSEG-AVG_ACT_G_CURR(1)           NE NODATA.
*    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
*    FTPOST-FNAM = 'BSEG-AVG_ACT_G_CURR                 '.
*    FTPOST-FVAL = BBSEG-AVG_ACT_G_CURR             .
*    APPEND FTPOST.
*  ENDIF.
*  IF BBSEG-AVG_ACT_L_CURR(1)           NE NODATA.
*    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
*    FTPOST-FNAM = 'BSEG-AVG_ACT_L_CURR                 '.
*    FTPOST-FVAL = BBSEG-AVG_ACT_L_CURR             .
*    APPEND FTPOST.
*  ENDIF.
*  IF BBSEG-AVG_ACT_T_CURR(1)           NE NODATA.
*    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
*    FTPOST-FNAM = 'BSEG-AVG_ACT_T_CURR                 '.
*    FTPOST-FVAL = BBSEG-AVG_ACT_T_CURR             .
*    APPEND FTPOST.
*  ENDIF.
*  IF BBSEG-BUDGET_PD(1)                NE NODATA.
*    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
*    IF XTBSL-KOART = 'S' OR XTBSL-KOART = 'A'.
*      FTPOST-FNAM = 'COBL-BUDGET_PD                      '.
*    ELSE.
*      FTPOST-FNAM = 'BSEG-BUDGET_PD                      '.
*    ENDIF.
*    FTPOST-FVAL = BBSEG-BUDGET_PD                  .
*    APPEND FTPOST.
*  ENDIF.
* END OF UD1K954413
ENDFORM.
