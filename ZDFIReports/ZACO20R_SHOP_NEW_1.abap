...
report  zaco20r_shop_new_1 message-id zmco no standard page heading.


tables : ztco_shop_sum_1,
         ztco_shop_cc_1,
         ztco_shop_sum,
         ztco_shop_CC,
         tka01,
...
data : it_shop_sum like table of ztco_shop_sum_1 with header line.
data : begin of it_shop_cc  occurs 0.
        include structure ztco_shop_cc_1.
...
data : begin of it_display occurs 0,
       ...
       KEY_AMT  like ztco_shop_CC_1-KEY_AMT,
       OSND_AMT  like ztco_shop_CC_1-OSND_AMT.
...
*- U1 Start
data: gt_ztco_shop_cc_a  type table of ztco_shop_cc_1 with header line,
      gt_ztco_shop_sum_a type table of ztco_shop_sum_1 with header line,
...
form alv_chg_fieldcat_1 tables pt_fieldcat type slis_t_fieldcat_alv.
  ...
  loop at pt_fieldcat into gs_fieldcat.
    ...
    case gs_fieldcat-fieldname.
      ...
      when 'KEY_AMT'.
        set_fieldcat gs_fieldcat 'Key in Amount'.
      when 'OSND_AMT'.
        set_fieldcat gs_fieldcat 'OS&D Amount'.
* Fixed
...
*decimal 4 amount, decimal 5 qty
  if l_pp_grqty <>  0 .
    ...
    it_display-KEY_AMT      = it_display-KEY_AMT      / l_pp_grqty.
    it_display-OSND_AMT     = it_display-OSND_AMT     / l_pp_grqty.
  endif.
...
form archive_read_ztco_shop_sum.
  ...
  data: l_handle    type sytabix,
        lt_ztco_shop_sum type table of ztco_shop_sum_1 with header line,
...
*  4.2 Read table from information
    ...
    call function 'ARCHIVE_GET_TABLE'
      exporting
        archive_handle          = l_handle
        record_structure        = 'ZTCO_SHOP_SUM_1'
...
*  4.2 Read table from information
    ...
    call function 'ARCHIVE_GET_TABLE'
      exporting
        archive_handle          = l_handle
        record_structure        = 'ZTCO_SHOP_CC_1'
        all_records_of_object   = 'X'
      tables
