REPORT zrfii18_org  MESSAGE-ID  zmfi.
*&--------------------------------------------------------------------
*& Author                 : Hs.Jeong
...
SELECTION-SCREEN END OF LINE.
SELECT-OPTIONS:
  s_fipos FOR fmfpo-fipos.   "default '600000' option GE,
...
*FM
    WHEN 'FS'.
      ...
      CLEAR wa_comm.
      READ TABLE ifmfpo  WITH KEY posit = f_posit.
      IF sy-subrc = 0.
        wa_comm = 'Q'.
      ENDIF.
      gt_out-fipos = ifmfpo-fipos.
      gt_out-ktext = ifmfpo-bezeich.
