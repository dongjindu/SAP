*&---------------------------------------------------------------------*
*& Program ID     : ZFMC0001                                           *
*& Program Name   : Budget upload using Excel                          *
*& Created by     : YN.Kim                                             *
...
*                                                                      *
*&=====================================================================*
REPORT  zfmc0001 NO STANDARD PAGE HEADING.

TABLES: zsfm0007.
TYPE-POOLS zfmcm.
INCLUDE <icon>.

DATA: zsfm0007_9000 LIKE zsfm0007_9000.

*-----/// Internal tables
DATA: it_9000 TYPE STANDARD TABLE OF zsfm0007_9000
                                     WITH HEADER LINE.
...
CONSTANTS: c_structure(100) VALUE 'ZSFM0007_'.
...
*>
      ...
      IF l_total = 0.
        ...
        MOVE: zfmcm_euro          TO it_9000-waers,
...
*<
  ...
  DELETE it_9000 WHERE fictr EQ space
                    OR fipex EQ space.
...
FORM generate_bdc .
  ...
  READ TABLE it_9000 WITH KEY fictr = it_fictr-fictr.
  ...
  CLEAR v_work.
  LOOP AT it_9000 WHERE fictr = it_fictr-fictr
                    AND ( icon = icon_led_yellow OR
                          icon = icon_led_red      ).
    ...
    WRITE: it_9000-per01 TO lv_peri1_01(21) CURRENCY zfmcm_euro,
           it_9000-per02 TO lv_peri1_02(21) CURRENCY zfmcm_euro,
           it_9000-per03 TO lv_peri1_03(21) CURRENCY zfmcm_euro,
           it_9000-per04 TO lv_peri1_04(21) CURRENCY zfmcm_euro,
           it_9000-per05 TO lv_peri1_05(21) CURRENCY zfmcm_euro,
           it_9000-per06 TO lv_peri1_06(21) CURRENCY zfmcm_euro,
           it_9000-per07 TO lv_peri1_07(21) CURRENCY zfmcm_euro,
           it_9000-per08 TO lv_peri1_08(21) CURRENCY zfmcm_euro,
           it_9000-per09 TO lv_peri1_09(21) CURRENCY zfmcm_euro,
           it_9000-per10 TO lv_peri1_10(21) CURRENCY zfmcm_euro,
           it_9000-per11 TO lv_peri1_11(21) CURRENCY zfmcm_euro,
           it_9000-per12 TO lv_peri1_12(21) CURRENCY zfmcm_euro.
...
*    MODIFY it_9000 TRANSPORTING icon zmsg
*                          WHERE  fictr = it_fictr-fictr
*                            AND ( icon = icon_led_yellow OR
*                                  icon = icon_led_red      ).
    LOOP AT it_9000 WHERE  fictr = it_fictr-fictr
                      AND ( icon = icon_led_yellow OR
  ...
  ELSE.
    MOVE: icon_led_green TO it_9000-icon,
          sy-msgv1       TO l_belnr.
*    MODIFY it_9000 TRANSPORTING icon belnr zmsg
*                          WHERE  fictr = it_fictr-fictr
*                            AND ( icon = icon_led_yellow OR
*                                  icon = icon_led_red      ).
    LOOP AT it_9000 WHERE  fictr = it_fictr-fictr
