*
* FM Budget Download / Release Monthly
*
...
*----bcd process fr35
        ...
        iout-aamt =  iout-aamt * -1.
        MOVE iout-aamt TO wa_amt.
      ...
      CASE itab-profil.
        ...
        WHEN 'Q'.   "Quarter
          ...
          IF p_per > 3 AND p_per < 7.
            mm = 03.
          ENDIF.
          IF p_per > 7 AND p_per < 10.
            mm = 06.
          ENDIF.
          IF p_per > 10 AND p_per <= 12.
            mm = 09.
          ENDIF.
          IF mm > 0.
            PERFORM cal_amt_symbol.
...
* commitment item text
  READ TABLE ifmci  WITH KEY fipos = iout-fipos.
  IF sy-subrc <> 0.
    CLEAR ifmci-bezei.
  ENDIF.
...
*   90(15) itab-aamt   ROUND p_r DECIMALS p_d NO-GAP.
