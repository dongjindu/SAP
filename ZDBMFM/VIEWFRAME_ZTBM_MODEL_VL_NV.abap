*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZTBM_MODEL_VL_NV
*   generation date: 09/17/2007 at 16:47:15 by user 103569
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZTBM_MODEL_VL_NV    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZTBM_MODEL_VL_NV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZTBM_MODEL_VL_NV_EXTRACT
TOTAL = ZTBM_MODEL_VL_NV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZTBM_MODEL_VL_NV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZTBM_MODEL_VL_NV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZTBM_MODEL_VL_NV_EXTRACT
TOTAL = ZTBM_MODEL_VL_NV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZTBM_MODEL_VL_NV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZTBM_MODEL_VL_NV'
...
TOTAL = ZTBM_MODEL_VL_NV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZTBM_MODEL_VL_NV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZTBM_MODEL_VL_NV-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZTBM_MODEL_VL_NV'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZTBM_MODEL_VL_NV-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZTBM_MODEL_VL_NV_EXTRACT
TOTAL = ZTBM_MODEL_VL_NV_TOTAL
