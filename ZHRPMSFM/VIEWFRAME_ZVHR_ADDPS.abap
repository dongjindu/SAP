*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVHR_ADDPS
*   generation date: 01/22/2013 at 14:43:20 by user T00289
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVHR_ADDPS          .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVHR_ADDPS'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVHR_ADDPS_EXTRACT
TOTAL = ZVHR_ADDPS_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVHR_ADDPS'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVHR_ADDPS-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVHR_ADDPS_EXTRACT
TOTAL = ZVHR_ADDPS_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVHR_ADDPS-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVHR_ADDPS'
...
TOTAL = ZVHR_ADDPS_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVHR_ADDPS-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVHR_ADDPS-UPD_FLAG NE SPACE.
