*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVHR_APPLV
*   generation date: 03/11/2013 at 08:38:54 by user T00289
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVHR_APPLV          .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVHR_APPLV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVHR_APPLV_EXTRACT
TOTAL = ZVHR_APPLV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVHR_APPLV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVHR_APPLV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVHR_APPLV_EXTRACT
TOTAL = ZVHR_APPLV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVHR_APPLV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVHR_APPLV'
...
TOTAL = ZVHR_APPLV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVHR_APPLV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVHR_APPLV-UPD_FLAG NE SPACE.
