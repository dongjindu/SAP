*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVHR_CLASS
*   generation date: 10/21/2013 at 14:47:40 by user T00306
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVHR_CLASS          .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVHR_CLASS'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVHR_CLASS_EXTRACT
TOTAL = ZVHR_CLASS_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVHR_CLASS'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVHR_CLASS-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVHR_CLASS_EXTRACT
TOTAL = ZVHR_CLASS_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVHR_CLASS-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVHR_CLASS'
...
TOTAL = ZVHR_CLASS_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVHR_CLASS-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVHR_CLASS-UPD_FLAG NE SPACE.
