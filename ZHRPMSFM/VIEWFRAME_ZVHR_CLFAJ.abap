*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVHR_CLFAJ
*   generation date: 01/09/2013 at 08:47:21 by user T00289
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVHR_CLFAJ          .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVHR_CLFAJ'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVHR_CLFAJ_EXTRACT
TOTAL = ZVHR_CLFAJ_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVHR_CLFAJ'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVHR_CLFAJ-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVHR_CLFAJ_EXTRACT
TOTAL = ZVHR_CLFAJ_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVHR_CLFAJ-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVHR_CLFAJ'
...
TOTAL = ZVHR_CLFAJ_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVHR_CLFAJ-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVHR_CLFAJ-UPD_FLAG NE SPACE.
