*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVHR_DPOOL
*   generation date: 01/08/2013 at 17:23:34 by user T00289
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVHR_DPOOL          .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVHR_DPOOL'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVHR_DPOOL_EXTRACT
TOTAL = ZVHR_DPOOL_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVHR_DPOOL'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVHR_DPOOL-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVHR_DPOOL_EXTRACT
TOTAL = ZVHR_DPOOL_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVHR_DPOOL-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVHR_DPOOL'
...
TOTAL = ZVHR_DPOOL_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVHR_DPOOL-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVHR_DPOOL-UPD_FLAG NE SPACE.
