*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVHR_LIMPD
*   generation date: 01/21/2014 at 13:28:16 by user HIS20037
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVHR_LIMPD          .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVHR_LIMPD'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVHR_LIMPD_EXTRACT
TOTAL = ZVHR_LIMPD_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVHR_LIMPD'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVHR_LIMPD-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVHR_LIMPD_EXTRACT
TOTAL = ZVHR_LIMPD_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVHR_LIMPD-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVHR_LIMPD'
...
TOTAL = ZVHR_LIMPD_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVHR_LIMPD-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVHR_LIMPD-UPD_FLAG NE SPACE.
