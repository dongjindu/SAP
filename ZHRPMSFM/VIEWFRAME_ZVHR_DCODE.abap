*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVHR_DCODE
*   generation date: 01/08/2013 at 17:08:58 by user T00289
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVHR_DCODE          .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVHR_DCODE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVHR_DCODE_EXTRACT
TOTAL = ZVHR_DCODE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVHR_DCODE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVHR_DCODE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVHR_DCODE_EXTRACT
TOTAL = ZVHR_DCODE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVHR_DCODE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVHR_DCODE'
...
TOTAL = ZVHR_DCODE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVHR_DCODE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVHR_DCODE-UPD_FLAG NE SPACE.
