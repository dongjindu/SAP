*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVHR_ITEMG
*   generation date: 12/12/2012 at 14:08:01 by user T00289
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVHR_ITEMG          .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVHR_ITEMG'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVHR_ITEMG_EXTRACT
TOTAL = ZVHR_ITEMG_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVHR_ITEMG'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVHR_ITEMG-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVHR_ITEMG_EXTRACT
TOTAL = ZVHR_ITEMG_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVHR_ITEMG-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVHR_ITEMG'
...
TOTAL = ZVHR_ITEMG_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVHR_ITEMG-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVHR_ITEMG-UPD_FLAG NE SPACE.
