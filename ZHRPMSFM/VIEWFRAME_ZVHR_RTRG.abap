*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVHR_RTRG
*   generation date: 11/28/2012 at 16:08:08 by user T00289
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVHR_RTRG           .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVHR_RTRG'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVHR_RTRG_EXTRACT
TOTAL = ZVHR_RTRG_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVHR_RTRG'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVHR_RTRG-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVHR_RTRG_EXTRACT
TOTAL = ZVHR_RTRG_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVHR_RTRG-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVHR_RTRG'
...
TOTAL = ZVHR_RTRG_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVHR_RTRG-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVHR_RTRG-UPD_FLAG NE SPACE.
