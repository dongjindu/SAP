*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVHR_APPLVE
*   generation date: 03/12/2013 at 16:46:47 by user T00289
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVHR_APPLVE         .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVHR_APPLVE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVHR_APPLVE_EXTRACT
TOTAL = ZVHR_APPLVE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVHR_APPLVE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVHR_APPLVE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVHR_APPLVE_EXTRACT
TOTAL = ZVHR_APPLVE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVHR_APPLVE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVHR_APPLVE'
...
TOTAL = ZVHR_APPLVE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVHR_APPLVE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVHR_APPLVE-UPD_FLAG NE SPACE.
