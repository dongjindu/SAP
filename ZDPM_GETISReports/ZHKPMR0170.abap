*&------------------------------------------------------------------
*& Program ID     : ZHKPMR0170
*& Profram Name   : PM TASK LIST I/F to GETIS
*& Created by     : HS
...
REPORT  zhkpmr0170 NO STANDARD PAGE HEADING MESSAGE-ID zdpm_getis .

INCLUDE ZHKPMR0170TOP. "Declare Data
INCLUDE ZHKPMR0170F01. "Process
