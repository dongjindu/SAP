*&------------------------------------------------------------------
*& Program ID     : ZHKPMR0060
*& Profram Name   : PM Material Month End Stock I/F to GETIS
*& Created by     : HS
...
REPORT  zhkpmr0060 NO STANDARD PAGE HEADING MESSAGE-ID zdpm_getis .

INCLUDE ZHKPMR0060TOP. "Declare Data
INCLUDE ZHKPMR0060F01. "Process
