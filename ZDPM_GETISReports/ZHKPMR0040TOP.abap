...
*&  TABLES
*&---------------------------------------------------------------------*
TABLES : equi, mara, mard, mbew, marc , t001w , ekpo, mkpf, mesg ,
         zvpm_mksg .
TABLES : usr01 .
*&---------------------------------------------------------------------*
*&  TYPE-POOL
...
SELECT-OPTIONS : s_matnr FOR mara-matnr ,
                 ...
                 s_bwart FOR zvpm_mksg-bwart ,
                 s_budat FOR zvpm_mksg-budat .
