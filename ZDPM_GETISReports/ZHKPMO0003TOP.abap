...
DATA : BEGIN OF gt_data OCCURS 0 ,
        mark ,
        icon(4) .
        INCLUDE STRUCTURE zhkpmt0010 .
DATA   END OF gt_data .

DATA : gt_send LIKE gt_data OCCURS 0 WITH HEADER LINE ,
       gt_mail LIKE gt_data OCCURS 0 WITH HEADER LINE .

DATA : BEGIN OF gt_row OCCURS 0 ,
        check .
        INCLUDE STRUCTURE zhkpmt0008 .
DATA   END OF gt_row .

DATA : gt_pmt0010 LIKE TABLE OF zhkpmt0010  WITH HEADER LINE .

*.
DATA : gt_cont_bin    LIKE solisti1 OCCURS 0 WITH HEADER LINE.
DATA : st_doc_header  LIKE sodocchgi1,
       gt_receivers   LIKE somlreci1 OCCURS 0 WITH HEADER LINE,
       gt_cont_txt    LIKE solisti1  OCCURS 0 WITH HEADER LINE,
       gt_packing     LIKE sopcklsti1 OCCURS 2 WITH HEADER LINE.
...
PARAMETERS : p_chk_a AS CHECKBOX DEFAULT 'X' ,
             p_chk_b AS CHECKBOX DEFAULT ' ' ,
             p_chk_c AS CHECKBOX DEFAULT ' ' .
