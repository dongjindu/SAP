*&------------------------------------------------------------------
*& Program ID     : ZHKPMR0220
*& Profram Name   : PM Maintenance Plan TBM List I/F to GETIS
*& Created by     : HS
...
REPORT  zhkpmr0220 NO STANDARD PAGE HEADING MESSAGE-ID zdpm_getis .

INCLUDE ZHKPMR0220TOP. "Declare Data
INCLUDE ZHKPMR0220F01. "Process
