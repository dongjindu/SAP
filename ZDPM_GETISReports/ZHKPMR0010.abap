*&------------------------------------------------------------------
*& Program ID     : ZHKPMR0010
*& Profram Name   : PM Material Master I/F to GETIS
*& Created by     : HS
...
REPORT  zhkpmr0010 NO STANDARD PAGE HEADING MESSAGE-ID zdpm_getis .

INCLUDE zhkpmr0010top . "Declare Data
INCLUDE zhkpmr0010f01 . "Process
