*&---------------------------------------------------------------------*
*&  Include           ZHKPMR0005TOP
*&---------------------------------------------------------------------*
*&---------------------------------------------------------------------*
*&  TABLES
*&---------------------------------------------------------------------*
TABLES : equi, t001, t001w, plko, plas, plmz, stpo , tapl .
TABLES : ctu_params .
...
DATA : BEGIN OF gt_data OCCURS 0 ,
        ...
        INCLUDE STRUCTURE zhkpms0040 .
DATA   END OF gt_data .

data : gt_sort like gt_data occurs 0 with header line .

DATA : gt_item LIKE TABLE OF zhkpms0050 WITH HEADER LINE .

DATA : gt_row LIKE TABLE OF zhkpmt0017 WITH HEADER LINE .

DATA : gt_oper LIKE TABLE OF zhkpmt0017 WITH HEADER LINE .
*&---------------------------------------------------------------------*
