*&------------------------------------------------------------------
*& Program ID     : ZHKPMR0190
*& Profram Name   : PM Maintenance Plan Notification List I/F to GETIS
*& Created by     : HS
...
REPORT  zhkpmr0190 NO STANDARD PAGE HEADING MESSAGE-ID zdpm_getis .

INCLUDE ZHKPMR0190TOP. "Declare Data
INCLUDE ZHKPMR0190F01. "Process
