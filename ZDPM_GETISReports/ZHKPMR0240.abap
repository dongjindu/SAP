*&------------------------------------------------------------------
*& Program ID     : ZHKPMR0240
*& Profram Name   : PM Maintenance Plan CBM List I/F to GETIS
*& Created by     : HS
...
REPORT  zhkpmr0240 NO STANDARD PAGE HEADING MESSAGE-ID zdpm_getis .

INCLUDE ZHKPMR0240TOP. "Declare Data
INCLUDE ZHKPMR0240F01. "Process
