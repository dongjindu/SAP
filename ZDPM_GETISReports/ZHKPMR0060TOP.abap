...
*&  TABLES
*&---------------------------------------------------------------------*
TABLES : equi, mara, mard, mbew, marc , t001w , mardh , bkpf .
TABLES : usr01 .
*&---------------------------------------------------------------------*
*&  TYPE-POOL
*&---------------------------------------------------------------------*
...
PARAMETERS : p_lfgja LIKE zhkpmt0006-lfgja ,
             p_lfmon LIKE zhkpmt0006-lfmon .
