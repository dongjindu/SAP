*&------------------------------------------------------------------
*& Program ID     : ZHKPMO0003
*& Profram Name   : PM Material Stock Shortage List & Alarm Mail
*& Created by     : HS
...
REPORT  ZHKPMO0003 NO STANDARD PAGE HEADING MESSAGE-ID zdpm_getis .

INCLUDE ZHKPMO0003top . "Declare Data
INCLUDE ZHKPMO0003f01 . "Process
