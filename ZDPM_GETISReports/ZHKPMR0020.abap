*&------------------------------------------------------------------
*& Program ID     : ZHKPMR0020
*& Profram Name   : PM Material Current Stock I/F to GETIS
*& Created by     : HS
...
REPORT  zhkpmr0020 NO STANDARD PAGE HEADING MESSAGE-ID zdpm_getis .

INCLUDE ZHKPMR0020TOP. "Declare Data
INCLUDE ZHKPMR0020F01. "Process
