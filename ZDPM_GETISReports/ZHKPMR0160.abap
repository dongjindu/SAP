*&------------------------------------------------------------------
*& Program ID     : ZHKPMR0160
*& Profram Name   : PM Maintenance Plan Actual List I/F to GETIS
*& Created by     : HS
...
REPORT  zhkpmr0160 NO STANDARD PAGE HEADING MESSAGE-ID zdpm_getis .

INCLUDE ZHKPMR0160TOP. "Declare Data
INCLUDE ZHKPMR0160F01. "Process
