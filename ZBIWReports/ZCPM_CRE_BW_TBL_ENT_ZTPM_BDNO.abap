...
* Description : Upload enteries for ZTPM_BDNO
*
*
* Modification Log
...
REPORT ZCPM_CRE_BW_TBL_ENT_ZTPM_BDNO   NO STANDARD PAGE HEADING
...
DATA: IT_T_REC1 LIKE ZTPM_BDNO OCCURS 0 WITH HEADER LINE.
****For Error Message
...
MODIFY ZTPM_BDNO FROM TABLE IT_T_REC1.
ENDLOOP.
