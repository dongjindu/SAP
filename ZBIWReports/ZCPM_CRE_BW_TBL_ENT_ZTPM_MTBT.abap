...
REPORT ZCPM_CRE_BW_TBL_ENT_ZTPM_MTBT   NO STANDARD PAGE HEADING
...
DATA: IT_T_REC1 LIKE ZTPM_MTBT OCCURS 0 WITH HEADER LINE.
****For Error Message
...
MODIFY ZTPM_MTBT FROM TABLE IT_T_REC1.
ENDLOOP.
