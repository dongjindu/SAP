...
REPORT ZCPM_CRE_BW_TBL_ENT_ZTPM_MONBD   NO STANDARD PAGE HEADING
...
MANDT LIKE ZTPM_BDNO-MANDT,
SHOP LIKE ZTPM_BDNO-SHOP,
AJAHR LIKE ZTPM_BDNO-AJAHR,
ZMONTH LIKE ZTPM_BDNO-ZMONTH,
END OF IT_T_REC.

DATA: IT_T_REC1 LIKE ZTPM_MONBD OCCURS 0 WITH HEADER LINE.
****For Error Message
...
MODIFY ZTPM_MONBD FROM TABLE IT_T_REC1.
ENDLOOP.
