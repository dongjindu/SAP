...
* Description : Upload enteries for ZTPM_MONBD
*
*
* Modification Log
...
REPORT ZCPM_CRE_BW_ZTPM_MTTR_MTBF_U   NO STANDARD PAGE HEADING
                             MESSAGE-ID ZMPM LINE-SIZE 200.

FIELD-SYMBOLS : <FS>.
tables: ZTPM_MTTR_MTBF_U.
*** For File Select
...
MANDT LIKE ZTPM_MTBT-MANDT,
SHOP LIKE ZTPM_MTBT-SHOP,
AJAHR LIKE ZTPM_MTBT-AJAHR,
ZMONTH LIKE ZTPM_MTBT-ZMONTH,
END OF IT_T_REC.

DATA: IT_T_REC1 LIKE ZTPM_MTTR_MTBF_U OCCURS 0 WITH HEADER LINE.
****For Error Message
...
MODIFY ZTPM_MTTR_MTBF_U FROM TABLE IT_T_REC1.
ENDLOOP.
