************************************************************************
* Program Name      : ZAPP_ZTPPERM_CHANGE_POINTER
* Author            : Wayne Kim
* Creation Date     : 10/14/2010
* Specifications By : Waybe Kim
* Pattern           :
* Development Request No:
* Addl Documentation:
* Description       : Creat the change pointers for the records in
*                     engine production interface table ZTPPERM.
*
* Modification Logs
* Date       Developer
* 10/14/2010 Wayne Kim  Copy it from ZAPP_ZTPPVR_CHANGE_POINTER
*
*
************************************************************************

REPORT zapp_ztpperm_change_pointer .

TABLES: ztpper.

CONSTANTS: c_equi(10)  TYPE c VALUE 'EQUI'.
DATA: it_er      LIKE ztpperm    OCCURS 0 WITH HEADER LINE.
