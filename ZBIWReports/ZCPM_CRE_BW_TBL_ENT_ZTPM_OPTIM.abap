...
* Description : Upload enteries for ZTPM_OPTIME
*
*
* Modification Log
...
REPORT ZCPM_CRE_BW_TBL_ENT_ZTPM_OPTIME   NO STANDARD PAGE HEADING
...
DATA: IT_T_REC1 LIKE ZTPM_OPTIME OCCURS 0 WITH HEADER LINE.
****For Error Message
...
MODIFY ZTPM_OPTIME FROM TABLE IT_T_REC1.
ENDLOOP.
