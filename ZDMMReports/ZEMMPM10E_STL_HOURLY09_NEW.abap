************************************************************************
* Program Name      : ZEMMPM10E_STL_HOURLY09_NEW
* Author            : Sung-Tae, Lim
* Creation Date     : 2004.04.23.
* Specifications By : Sung-Tae, Lim
* Development Request No : UD1K909855
* Addl Documentation: ( Copy of ZEMMPM10E_STL_HOURLY09 )
* Description       : Supply to Line - RP09
*
* Modification Logs
* Date            Developer        RequestNo      Description
* 2004.04.23.     Sung-Tae Lim     UD1K909855     Initial Coding
*08/29/06         Manju            UD1K921901     Manual Re-processing
*                                                 Options
  ...
  SELECT a~rsnum            "Reservation number
         ...
         b~zmnmx            " Min or Max
                ...
                WHERE a~rsnum EQ lt_rsnum-rsnum    "Reservation number
                  AND b~werks EQ 'P001'
                  AND b~spptl EQ 'S'
** Changed by Furong on 09/17/08
*                  AND zline IN ('F4', 'OK').
                  AND zline IN ('F4', 'F5', 'OK')
** End of change
...
*--- App Doc No
    ...
    IF w_minus_stock_check EQ space.
*** commented by Furong on 08/10/2005
