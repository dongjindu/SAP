*----------------------------------------------------------------------*
*   INCLUDE ZIMMGM26I_6020TOP                                          *
*----------------------------------------------------------------------*
*/ Itab & wa for ZTMM_6020_01
* ZTMM_6020_01: Vendor Master Interface Table
*  DATA: BEGIN OF wa_ztmm_6020_01,
...
*        END OF wa_ztmm_6020_01.

  DATA: BEGIN OF wa_ztmm_6020_01.
          INCLUDE STRUCTURE ztmm_6020_01.
  DATA:  ktokk LIKE lfa1-ktokk,
        END OF wa_ztmm_6020_01.

  DATA: it_ztmm_6020_01 LIKE TABLE OF wa_ztmm_6020_01.
  FIELD-SYMBOLS: <fs_ztmm_6020_01> LIKE LINE OF it_ztmm_6020_01.
