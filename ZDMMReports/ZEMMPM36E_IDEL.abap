...
*                                               Probelm
* 04/04/2006      Manju            UD1K919888   Enhance KD ASN Process
*                                               to include BOL# in
*                                               delivery header.
************************************************************************
...
END-OF-SELECTION.
  ...
  ELSE.
    IF p_update EQ c_check.
      PERFORM create_delivery TABLES it_9000.
      PERFORM update_table TABLES it_9000.
    ENDIF.
