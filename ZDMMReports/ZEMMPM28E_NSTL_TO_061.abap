************************************************************************
* Program Name      : ZEMMPM28E_NSTL_TO_061
* Author            : Hakchin Kim
...
* 2004.05.04.  Sung-Tae Lim    UD1K910127     Initial Coding
*
************************************************************************

REPORT zemmpm28e_nstl_to_061 MESSAGE-ID zmmm
...
*    DO 10 TIMES.
    DO w_tot_lines TIMES.
      ...
      READ TABLE it_ztmm_nstl_time INDEX sy-index.
    ...
    ELSEIF w_2shift_exec NE space.
      ...
      CHECK ( <fs_data_for_to>-stime BETWEEN it_worktime-begzt
         ...
         OR ( <fs_data_for_to>-stime BETWEEN '000000'
                                         AND it_worktime-endzt ).
*      CHECK <fs_data_for_to>-stime BETWEEN w_2stime AND w_2etime.
    ENDIF.
*--- App Doc No
