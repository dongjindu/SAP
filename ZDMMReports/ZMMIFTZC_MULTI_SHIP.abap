...
*& 09/24/2010  Matthew  UD1K949839      Add 'T'est cars to logic
*&--------------------------------------------------------------------&*
...
** End of chnage
  ...
  ENDIF.
ENDIF.
** Changed by Matthew Cupples on 09/24/10
...
LOOP AT IT_AUSP ASSIGNING <FS_AUSP>
                WHERE ATINN EQ W_ATINN11
                AND ( ATWRT NE 'P' AND ATWRT NE 'T' ).
** End of change by Matthew Cupples
