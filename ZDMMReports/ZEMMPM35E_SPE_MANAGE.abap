...
*
************************************************************************
REPORT zemmpm35e_spe_manage NO STANDARD PAGE HEADING
                            LINE-SIZE  126
                            LINE-COUNT  65.
INCLUDE: <icon>.
TYPE-POOLS : slis.
...
SELECTION-SCREEN COMMENT  1(31) text-t13 FOR FIELD r_year.
...
PARAMETERS       r_year RADIOBUTTON GROUP rd1
                                              USER-COMMAND rd1.
...
*----- read material master conversion rule
    IF it_info-kumne IS INITIAL OR it_info-kumza IS INITIAL.
      ...
      IF sy-subrc NE 0.
        MESSAGE e000(zz) WITH wa_vakey(10) wa_price-matnr text-m11.
      ENDIF.
    ENDIF.
