************************************************************************
* Program Name      : ZEMMPM28E_NSTL_061
* Author            : Sung-Tae, Lim
...
REPORT zemmpm28e_nstl_061 NO STANDARD PAGE HEADING
                          LINE-SIZE 255
                          LINE-COUNT 64(1)
                          MESSAGE-ID zmmm.
...
CONSTANTS : c_werks LIKE t001w-werks VALUE 'P001',
            ...
            c_atwrt_04 LIKE ausp-atwrt VALUE '04',
...
END-OF-SELECTION.
  ...
  ELSE.
    ...
    IF p_check NE space.
      SUBMIT zemmpm28e_nstl_to_061 WITH p_tocred = p_datum
...
*---
  ...
  LOOP AT it_itab.
    ...
    MOVE : c_rp06              TO ztmm_nstl-rpsta.
