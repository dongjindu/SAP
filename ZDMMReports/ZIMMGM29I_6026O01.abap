...
* 'wa_disvariant' must at least contain the report-id to allow
* § At least field REPORT of this structure has to be filled!
    wa_disvariant-report = sy-repid.
    w_save = 'A'.  "Both user-defined and global layouts can be saved.
...
*    IT_ALV_GRAPHICS               =
      CHANGING
        it_outtab                  = it_ztmm_6026_01 "field text change
