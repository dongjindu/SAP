...
*/ Begin of Changed by Hakchin(20040127)
*  SELECT rsnum
...
*    WHERE rp06 LIKE lv_rp06_timestamp.  "Related to PBS Out
  ...
  ENDLOOP.
*/ End of Changed by Hakchin(20040127)
