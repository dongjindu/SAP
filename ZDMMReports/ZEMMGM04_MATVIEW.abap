************************************************************************
* Program name: ZEMMGM04_MATVIEW                                       *
* Created by  : hj.song                                                *
* Created on  : 2003.09.04.                                            *
* Pattern     :
* Description : Material view extension(create table mat.group info)   *
*                                                                      *
* Modification Log                                                     *
...
REPORT  zemmgm04_matview  MESSAGE-ID zmmm.
...
SELECT-OPTIONS : s_matkl  FOR  t023-matkl NO-EXTENSION,
                 s_mtart  FOR  t134-mtart NO-EXTENSION.
...
FORM select_data.
  ...
  SELECT matkl INTO CORRESPONDING FIELDS OF TABLE it_list
         FROM t023
        WHERE matkl IN s_matkl.
  LOOP AT it_list.
    CLEAR  *ztmm_magroup.
    SELECT SINGLE * INTO *ztmm_magroup
           FROM ztmm_magroup
          WHERE matkl = it_list-matkl.
...
FORM copy_data.
  ...
  it_list-mtart   =    sy-mandt.
*    it_list-MATKL   =    ZTMM_MAGROUP-MATKL.
  it_list-mtart   =    ztmm_magroup-mtart.
  it_list-class   =    ztmm_magroup-class.
  it_list-ekgrp   =    ztmm_magroup-ekgrp.
**S>08/04/11 Paul : Not used Fields to comment.

*  it_list-disgr   =    ztmm_magroup-disgr.
  it_list-kautb   =    ztmm_magroup-kautb.
  it_list-xchpf   =    ztmm_magroup-xchpf.
*  it_list-fabkz   =    ztmm_magroup-fabkz.
*  it_list-dismm   =    ztmm_magroup-dismm.
*  it_list-minbe   =    ztmm_magroup-minbe.
  it_list-meins   =    ztmm_magroup-meins.
...
FORM check_required_filed
  ...
  IF p_ztmm_magroup-mtart = ''
  OR p_ztmm_magroup-class = ''
*  OR p_ztmm_magroup-disgr = ''
*  OR p_ztmm_magroup-dismm = ''
*  OR p_ztmm_magroup-dispo = ''
*  OR p_ztmm_magroup-disls = ''
*  OR p_ztmm_magroup-fhori = ''
  OR p_ztmm_magroup-bklas = ''
