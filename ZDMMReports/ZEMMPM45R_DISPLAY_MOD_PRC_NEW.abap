...
data : begin of it_tab occurs 0,
       ...
       PREF like ztbm_abxduldt-pref,
       COMP  like ztbm_abxduldt-comp,
       MAKTX1 LIKE  makt-maktx ,
       QNTY like ztbm_abxduldt-qnty,
       UNIT LIKE   ztbm_abxduldt-unit,
       MEINS LIKE   mara-meins,
       EKGRP LIKE   ekko-ekgrp,
       MCODE like ztmm_assy_cost1-mcode,
       DATAB1 LIKE   ztmm_assy_cost1-datab ,
       DATBI1 LIKE   ztmm_assy_cost1-datbi ,
       STGB like ztbm_abxduldt-stgb,
      end of it_tab.
...
FORM check_mcode.
  ...
  ELSE.
    ...
    concatenate '%' s_mcode-low '%' into l_mcode.
  ENDIF.
ENDFORM.                    " check_mcode
*&---------------------------------------------------------------------*
*&      Form  check_lifnr
...
* Get all the Modules
  SELECT a~VTYPE          A~LIFNR a~MCODE A~EKGRP
         a~ASYTR          A~DATAB          A~DATBI
         g~MTNO as matnr  g~comp as UPGVC d~maktx v~name1 as NAME1
         g~UNIT as unit m~meins as MEINS
...
*       it_output-DATAB = it_scomp-DATUV .
*       it_output-DATBI = it_scomp-DATUB .
      append it_output.
    endloop.
    clear it_output.
  endloop.
