...
REPORT  zrmmpm21r_container_call.
                     ...
                     FROM lips AS lp INNER JOIN likp AS lk
                      ...
                      AND lp~vbeln = lk~vbeln
                          INNER JOIN vbuk AS vb
                             ON lk~mandt EQ vb~mandt
                            AND lk~vbeln = vb~vbeln
...
*    w_col_pos 'NOTYETGR' 12 'Not Yet GR'   'QUAN' ' '  'MEINS' '' '',
    ...
    w_col_pos 'TRAID' 20 'Container Number' 'CHAR'  ''  ''  ''  '',
    w_col_pos 'ZFRETA' 10 'Dated Arrival Mobile' 'DATS' '' '' '' ''.
...
* LS_LINE-KEY:  not used for this type
  ls_line-info = text-100.   "Container Call List
...
*---
  ...
  CLEAR : wa_fieldcat[], wa_events[], wa_list_top_of_page[].
