** changed by FR Wang on 05/31/05, requested by KB Lee *

REPORT zrmmgm03r_inforecord.
...
data: itab_zvmm_info like zvmm_info_condi occurs 0 with header line.
...
SELECT-OPTIONS : s_matnr FOR zvmm_inforecord-matnr,
                 s_mtart FOR mara-mtart DEFAULT 'ROH' NO INTERVALS,
...
FORM get_data.
  ...
  LOOP AT it_knumh.
    SELECT SINGLE name1 ekgrp
      INTO (it_knumh-name1,it_knumh-ekgrp)
...
** added by FR Wang
 SELECT *
    INTO CORRESPONDING FIELDS OF TABLE itab_zvmm_info
    FROM zvmm_info_condi
     FOR ALL ENTRIES IN it_zvmm_info_condi
     WHERE knumh    = it_zvmm_info_condi-knumh
     AND ( kschl = 'ZP16' or kschl = 'ZP17' or kschl = 'ZP18' )
     AND loevm_ko = ' '.
 sort itab_zvmm_info by knumh.
** end of addition
...
** added by FR Wang
    loop at itab_zvmm_info where knumh = it_zvmm_info_condi-knumh.
      case itab_zvmm_info-kschl.
      when 'ZP16'.
        it_9000-zp16 = itab_zvmm_info-kbetr.
      when 'ZP17'.
        it_9000-zp17 = itab_zvmm_info-kbetr.
      when 'ZP18'.
        it_9000-zp18 = itab_zvmm_info-kbetr.
      endcase.
    endloop.
** end of addition

    MOVE: it_knumh-matnr           TO it_9000-matnr,
          it_knumh-lifnr           TO it_9000-lifnr,
          it_knumh-name1           TO it_9000-name1,
          it_knumh-ekgrp           TO it_9000-ekgrp,
          it_knumh-datab           TO it_9000-datab,
          it_knumh-datbi           TO it_9000-datbi,
          it_matnr-mtart           TO it_9000-mtart,
          it_matnr-profl           TO it_9000-profl,
          it_matnr-maktx           TO it_9000-maktx,
          it_zvmm_info_condi-kbetr TO it_9000-kbetr,
          it_zvmm_info_condi-kzust TO it_9000-kzust,
          it_zvmm_info_condi-kpein TO it_9000-kpein,
          it_zvmm_info_condi-kmein TO it_9000-kmein,
          it_zvmm_info_condi-konwa TO it_9000-konwa.
...
*----------------------------------------------------------------------*
FORM check_matnr.
  SELECT a~matnr a~mtart a~profl b~maktx
