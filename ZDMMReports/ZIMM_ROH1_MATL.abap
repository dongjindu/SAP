...
REPORT zimm_roh1_matl NO STANDARD PAGE HEADING
                     LINE-SIZE 132
                     LINE-COUNT 64(1)
                     MESSAGE-ID zmmm.

TYPE-POOLS: slis, vrm.
TABLES: ztmm_roh1_matl, mara, t001.
*DATA: IT_DATA LIKE TABLE OF ZTMM_PILOT_MATL WITH HEADER LINE.

DATA: BEGIN OF it_data OCCURS 0.
        INCLUDE STRUCTURE ztmm_roh1_matl.
DATA: END OF it_data.
...
*        AND MATKL = 'AM'
          ...
          AND ( mstae = '12' OR mstae = '11' ).

      REFRESH it_data.
      LOOP AT lt_temp.
        it_data-matnr = lt_temp-matnr.
        it_data-ersda = lt_temp-ersda.
        APPEND it_data.
      ENDLOOP.
** End of change
...
*  ENDIF.
  ...
  MODIFY ztmm_roh1_matl FROM TABLE it_data.
  IF sy-subrc = 0.
    COMMIT WORK.
  ELSE.
    ROLLBACK WORK.
...
FORM send_email.
  ...
  LOOP AT it_data.
    MOVE: it_data-matnr TO lt_body+0(20),
          it_data-steel_mat TO lt_body+20(30).
    APPEND lt_body.
  ENDLOOP.
