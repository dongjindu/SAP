...
*&
*&---------------------------------------------------------------------*
REPORT  ZRIMMATLST  MESSAGE-ID ZIM
                     LINE-SIZE 90
...
FORM P2000_SORT_DATA.
  ...
  SORT  IT_BL  BY  MATNR  WERKS  LGORT  EBELN  EBELP.
...
*>> 미통관 자료인 경우만 WRITE.
  ...
  SORT  IT_TAB  BY  MATNR  WERKS  LGORT  EBELN  EBELP.
