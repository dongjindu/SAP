...
*--------------------------------------------------------------------
  ...
  WRITE : / SY-VLINE NO-GAP,'B/L(AWB)번호',
         ...
         100 SY-VLINE NO-GAP,'징수 형태',ZTIDR-ZFCOCD,
         120 SY-VLINE NO-GAP.
...
FORM P3000_LAST_WRITE.
  ...
  DATA: W_TEXT1(30) TYPE C, "인도조건-통화종류-금액-결제방법.
        W_ZFSTAMT(16),      "결제금액.
        W_ZFAAMT   LIKE ZTIDR-ZFVAAMTS. " 부가가치세과표.
...
FORM P3000_HEAD_WRITE.
  ...
  WRITE : / SY-VLINE NO-GAP,'신  고  자:',ZTIDR-ZFAPNM,
         60 SY-VLINE NO-GAP,'통관계획',ZTIDR-ZFCUPR,
         80 SY-VLINE NO-GAP,'원산지증명서',
        100 SY-VLINE NO-GAP,'총  중  량',ZTIDR-ZFTOWTM,
        120 SY-VLINE NO-GAP.
*  ADD 1 TO W_LINE.PERFORM P2000_PAGE_CHECK.
  WRITE : / SY-VLINE NO-GAP,
        ...
        120 SY-VLINE NO-GAP.
*  ADD 1 TO W_LINE.PERFORM P2000_PAGE_CHECK.
  WRITE : / SY-VLINE NO-GAP,'수  입  자:',ZTIDR-ZFIAPNM,
         60 SY-ULINE,
        120 SY-VLINE NO-GAP.
*  ADD 1 TO W_LINE.PERFORM P2000_PAGE_CHECK.
...
* DOMAIN.-----------------------------------------------------------
  ...
  WRITE : / SY-VLINE NO-GAP,
         60 SY-VLINE NO-GAP,'신고구분',ZTIDR-ZFIDRCD,
         80 SY-VLINE NO-GAP,'가격신고서',
        100 SY-VLINE NO-GAP,'총포장갯수',ZTIDR-ZFPKNM,
        120 SY-VLINE NO-GAP.
*  ADD 1 TO W_LINE.PERFORM P2000_PAGE_CHECK.
  WRITE : / SY-VLINE NO-GAP,'납세의무자:',ZTIDR-ZFTDNM1,
        ...
        120 SY-VLINE NO-GAP.
*  ADD 1 TO W_LINE.PERFORM P2000_PAGE_CHECK.
  WRITE : / SY-VLINE NO-GAP,6'(주소):',ZTIDR-ZFTDAD1,ZTIDR-ZFTDAD2,
          60 SY-ULINE,
         120 SY-VLINE NO-GAP.
* DOMAIN.-----------------------------------------------------------
  ...
  WRITE : / SY-VLINE NO-GAP,6'(상호):',ZTIDR-ZFTDNM1,
         60 SY-VLINE NO-GAP,'거래구분',
         80 SY-VLINE NO-GAP,'국내도착항',ZTIDR-ZFAPRTC,
        100 SY-VLINE NO-GAP,'운송 형태',ZTIDR-ZFTRMET,
        120 SY-VLINE NO-GAP.
*  ADD 1 TO W_LINE.PERFORM P2000_PAGE_CHECK.
  WRITE : / SY-VLINE NO-GAP,6'(성명):',ZTIDR-ZFTDNM2,
...
*  ADD 1 TO W_LINE.PERFORM P2000_PAGE_CHECK.
  ...
  WRITE : / SY-VLINE NO-GAP,'무역대리점:',ZTIDR-ZFTRDNM,
         60 SY-VLINE NO-GAP,'종류',ZTIDR-ZFITKD,  " 도메인.
         80 SY-VLINE NO-GAP,'적출국',ZTIDR-ZFSCON,T005T-LANDX,
        120 SY-VLINE NO-GAP.
*  ADD 1 TO W_LINE.PERFORM P2000_PAGE_CHECK.
...
* DOMAIN.-----------------------------------------------------------
  ...
  WRITE : / SY-VLINE NO-GAP,'공  급  자:',ZTIDR-ZFSUPNM,
         60 SY-VLINE NO-GAP, W_DOM_TEX1,
         80 SY-VLINE NO-GAP,'선기명',(20)ZTIDR-ZFCARNM,
        120 SY-VLINE NO-GAP.
*  ADD 1 TO W_LINE.PERFORM P2000_PAGE_CHECK.
  WRITE : / SY-VLINE NO-GAP,
         60 SY-ULINE,
...
*  ADD 1 TO W_LINE.PERFORM P2000_PAGE_CHECK.
  WRITE : / SY-ULINE.
*  ADD 1 TO W_LINE.PERFORM P2000_PAGE_CHECK.
  WRITE : / SY-VLINE NO-GAP,'검사(반입)장소',ZTIDR-ZFISPL,
