...
*&  적용회사PJT:                                                       *
*&---------------------------------------------------------------------*
*&   DESC.     : 구매승인신청서  프린터 하기위한 리스트 출력.
*&
*&---------------------------------------------------------------------*
*& [변경내용]
*&
*&---------------------------------------------------------------------*
REPORT  ZRIMPUPRT   MESSAGE-ID ZIM
                     LINE-SIZE 120
   ...
   WRITE:/  SY-VLINE, (20) ' ',
        ...
        /   SY-VLINE, (20)  IT_TAB2-ZFSDOC,
            ...
            SY-VLINE,  (3)  IT_TAB2-WAERS,
                      (16) IT_TAB2-ZFGOAMT CURRENCY IT_TAB2-WAERS,"금액'
