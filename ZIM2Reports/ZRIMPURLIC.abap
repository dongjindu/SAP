...
*&
*&---------------------------------------------------------------------*
REPORT  ZRIMPURLIC    MESSAGE-ID ZIM
                     LINE-SIZE 116
...
FORM P3000_DATA_WRITE USING      W_ERR_CHK.
  ...
  SET  PF-STATUS 'PURLIC'.           " GUI STATUS SETTING
  SET  TITLEBAR  'PURLIC'.           " GUI TITLE SETTING..
...
*                (20)IT_ZTPURSG1-MENGE, (20)IT_ZTPURSG1-MEINS,
                (20)W_TEM, '   ',
*                (20)IT_ZTPURSG1-NETPR, (20)IT_ZTPURSG1-ZFGOAMT.
   ...
   WRITE:/23 'TOTAL', 54 W_TEM, 95 W_PRICE.
...
FORM P1000_GET_IT_TAB USING W_ERR_CHK.
   ...
   CASE ZTREQST-ZFDOCST.
        WHEN 'N'.
             MESSAGE S104 WITH P_REQNO P_AMDNO 'None'.
             LEAVE PROGRAM.
        WHEN 'R'.
              MESSAGE S104 WITH P_REQNO P_AMDNO 'EDI 의뢰'.
             LEAVE PROGRAM.
        WHEN 'C'.
             MESSAGE S104 WITH P_REQNO P_AMDNO 'Cancle'.
             LEAVE PROGRAM.
   ENDCASE.
