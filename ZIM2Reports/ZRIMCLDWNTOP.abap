...
*----------------------------------------------------------------------*
*&  프로그램명 : 수입신고 자료의 Download를 위한 Include               *
...
* Download ?
*-----------------------------------------------------------------------
DATA: BEGIN OF IT_ZTIDR OCCURS 0,
...
DATA: BEGIN OF IT_ZTIDRHS OCCURS 0,
      ZFIDRNO(14)         TYPE C,                " 수입신고번?
      ZFCONO(3)           TYPE C,                " 란번?
      ZFCURT(6)           TYPE C,                " 관세?
...
DATA: BEGIN OF IT_ZTIDRHSD OCCURS 0,
      ZFIDRNO(14)         TYPE C,                " 수입신고번?
      ZFCONO(3)           TYPE C,                " 란번?
...
DATA: BEGIN OF IT_ZTIDRHSL OCCURS 0,
      ZFIDRNO(14)         TYPE C,                " 수입신고번?
      ZFCONO(3)           TYPE C,                " 란번?
...
DATA : W_TEXT_AMOUNT(18)  TYPE  C,
       W_TEXT_QUN(10)     TYPE  C,
       W_TEXT_QUN1(15)    TYPE  C.
