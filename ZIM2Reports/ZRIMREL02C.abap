...
*&      작성일 : 2002.05.31                                            *
*&---------------------------------------------------------------------*
*&   DESC.     : Config에서 구매 Released 된 수입의뢰 건만 보여준다.
*&---------------------------------------------------------------------*
*& [변경내용]
*&---------------------------------------------------------------------*
...
SELECT-OPTIONS: S_APPDT   FOR ZTREQST-ZFAPPDT,  " 개설신?
...
PARAMETERS : P_NOOPEN   NO-DISPLAY. "AS CHECKBOX.
PARAMETERS : P_OPEN     NO-DISPLAY. "AS CHECKBOX.
