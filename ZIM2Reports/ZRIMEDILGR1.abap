...
*& Report  ZRIMEDILGR1                                                 *
*&---------------------------------------------------------------------*
*&  프로그램명 : EDI RECEIPT(L/G EDS VAN I/F용)                        *
...
*&---------------------------------------------------------------------*
*& [변경내용]
*& 김영광 (LG-CNS) : 회사코드별 EDI IMG참조하여 수신 및 백업 작업하도록
*&                   수정 (2002.01.22)
*&
*&---------------------------------------------------------------------*
REPORT  ZRIMEDILGR1  MESSAGE-ID ZIM
                     LINE-SIZE 120
...
SELECTION-SCREEN BEGIN OF BLOCK B1 WITH FRAME TITLE TEXT-001.
   SELECT-OPTIONS: S_BUKRS  FOR ZTIMIMG00-ZFBUKRS.
...
DATA: L_STRLEN           TYPE I,
   ...
   CONCATENATE 'cd' ZTIMIMGTX-ZFRECV INTO L_COMMAND SEPARATED BY SPACE.
...
*      ID 'DSTLEN' FIELD MI_PWD_LEN.
  ...
  CALL FUNCTION 'FTP_CONNECT'
       EXPORTING
           USER            = ZTIMIMGTX-UNAME
           PASSWORD        = ZTIMIMGTX-PASSW
           HOST            = ZTIMIMGTX-HOST
